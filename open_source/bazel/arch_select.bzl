...
def whl_deps():
    return select({
        ...
        "@//:using_rocm": ["pyrsmi==0.2.0", "amdsmi@https://sinian-metrics-platform.oss-cn-hangzhou.aliyuncs.com/kis%2FAMD%2Famd_smi%2Fali%2Famd_smi.tar", "aiter@https://siwei-zm.oss-cn-hangzhou-zmf.aliyuncs.com/MI308X/deps/aiter-0.1.10%2Bgit.a75b522b.date.202512311754-cp310-cp310-linux_x86_64.whl"],
