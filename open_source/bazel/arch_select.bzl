...
def whl_deps():
    return select({
        ...
        "@//:using_rocm": ["pyrsmi==0.2.0", "amdsmi@https://sinian-metrics-platform.oss-cn-hangzhou.aliyuncs.com/kis%2FAMD%2Famd_smi%2Fali%2Famd_smi.tar", "aiter@https://434934.oss-cn-hangzhou-zmf.aliyuncs.com/wenhua/aiter-0.1.11.dev11%2Bg371a22f0d.d20260409-cp310-cp310-linux_x86_64.whl"],
