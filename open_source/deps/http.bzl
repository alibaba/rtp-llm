...
def http_deps():
    ...
    http_archive(
        name = "aiter",
        sha256 = "dcff9229bd353b8e07d08fa950f4ab488a20a6cf3129d3a338c2cadc137d94bb",
        urls = [
	        "https://search-ad.oss-cn-hangzhou-zmf-internal.aliyuncs.com/amd_pkgs/aiter-0.1.0%2Bdate.202509221726-py3-none-any.whl",
	    ],
        type = "zip",
