...
def http_deps():
    ...
    http_archive(
        name = "aiter",
        sha256 = "2bf6df4b6aa99f08b18f5799fd8d727a5a93aabb6c9bcbe6311d511d693df341",
        urls = [
            "https://sinian-metrics-platform.oss-cn-hangzhou.aliyuncs.com/kis/AMD/aiter/aiter-0.1.17.dev79%2Bg2570b35f9.d20260714-cp310-cp310-linux_x86_64.whl",
        ],
        type = "zip",
    ...
    http_file(
        ...
        urls = [
            "https://rtp-opensource.oss-cn-hangzhou.aliyuncs.com/package/kvcm/kv_cache_manager%25252Fclient%25252Fkv-cache-manager-client-2026_04_22_10_35.rpm",
        ],
        sha256 = "8774d9565bb7b24caa6da6ec6690c24c329ee6fd7f76c9a39effba68098bdbbe",
    )
