...
def http_deps():
    ...
    http_archive(
        ...
        urls = [
            "http://search-ad.oss-cn-hangzhou-zmf-internal.aliyuncs.com/kv_cache_manager%2Fserver%2Fkv_cache_manager_server_2025_11_21_10_14.tar.gz",
        ],
        sha256 = "c3b8c1bda960a49e60f2bafdb205763f46b1cad051c3375f3acc8f3878836430",
        build_file_content = """
