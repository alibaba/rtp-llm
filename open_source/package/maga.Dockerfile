...
ADD atrex-0.0.1-py3-none-any.whl /tmp/atrex-0.0.1-py3-none-any.whl
RUN /opt/conda310/bin/pip install /tmp/atrex-0.0.1-py3-none-any.whl \
    -i https://artifacts.antgroup-inc.cn/simple/ \
    --extra-index-url=https://mirrors.aliyun.com/pypi/simple/ \
    --extra-index-url=https://download.pytorch.org/whl/cu126 \
    && rm /tmp/atrex-0.0.1-py3-none-any.whl
