...
class TestRotaryKVcacheTest(unittest.TestCase):
    ...
    def _test_one_case(self, sequence_lengths: List[int], intput_lengths: List[int], page_size: int):
        ...
        self.mla_rotary_kvcache_op.init(prefix_length_t, sequence_length_mins_one, torch.tensor(intput_lengths, dtype=torch.int32), page_size, block_id_map, block_id_map_device)
