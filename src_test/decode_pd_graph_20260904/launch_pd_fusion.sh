...
BASE_WORK="${BASE_WORK_OVERRIDE:-/tmp/rtp_llm_prefill_unified_scr_expandable_false_bypass_true_20260904}"
...
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:False,large_segment_size_mb:1024
