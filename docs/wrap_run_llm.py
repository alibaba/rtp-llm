...
def insert_runllm_widget(html_content):
    ...
    <script type="module" id="runllm-widget-script" src="https://widget.runllm.com" crossorigin="true" version="stable" runllm-keyboard-shortcut="Mod+j" runllm-name="RTP-LLM Chatbot" runllm-position="BOTTOM_RIGHT" runllm-assistant-id="629" async></script>
    """
