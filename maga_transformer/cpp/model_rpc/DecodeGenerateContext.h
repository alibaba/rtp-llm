...
public:
    DecodeGenerateContext(DecodeRpcContext& rpc_context, int64_t timeout_ms,
                          grpc::ServerContext* server_context,
                          kmonitor::MetricsReporterPtr& metrics_reporter) 
                          : GenerateContext(0, timeout_ms, server_context, metrics_reporter),
...
public:
    ...
    //std::string                 peer_ip;
    std::vector<std::string>    peer_ips; //prefill worker ips
