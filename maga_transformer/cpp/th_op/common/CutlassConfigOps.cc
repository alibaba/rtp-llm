...
static auto insert_fp16_int4_gemm_config =
    torch::RegisterOperators("rtp_llm::insert_fp16_int4_gemm_config", &torch_ext::insertFp16Int4GemmConfig);
static auto insert_w8a8_gemm_config =
    torch::RegisterOperators("rtp_llm::insert_w8a8_gemm_config", &torch_ext::insertW8A8GemmConfig);