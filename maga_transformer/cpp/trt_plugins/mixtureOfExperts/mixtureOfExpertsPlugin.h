...
#include "maga_transformer/cpp/utils/quantization.h"
#include "maga_transformer/cpp/cutlass/cutlass_kernels/moe_gemm/moe_kernels.h"
#include "maga_transformer/cpp/cutlass/cutlass_kernels/moe_gemm/moe_fp8_kernels.h"
...
public:
    ...
    MixtureOfExpertsPlugin(int number_of_experts, int top_k, bool normalize_expert_scale, int expert_hidden_size,
        int expert_inter_size, rtp_llm::ActivationType activation_type, nvinfer1::DataType type,
