...
public:
    void RunMoeTest(
        ...
        const auto expert_scales = device_->allocateBuffer({DataType::TYPE_FP32, {rtp_llm::pad_to_multiple_of_16(token_num * top_k)}});

        const auto expanded_source_row_to_dest = device_->allocateBuffer({DataType::TYPE_INT32, {rtp_llm::pad_to_multiple_of_16(token_num * top_k)}});
        const auto expert_for_source_row = device_->allocateBuffer({DataType::TYPE_INT32, {rtp_llm::pad_to_multiple_of_16(token_num * top_k)}});
