...
void GroupedGemmParams::check() const {
    ...
    for (int i = 0; i < int(a_size); i++) {
        ...
        RTP_LLM_CHECK_WITH_INFO((a_dim == 2 && b_dim == 2 && c_dim == 2),
        ...
        RTP_LLM_CHECK_WITH_INFO((a_type == b_type && b_type == c_type),
