...
TEST_F(DFAUtilTest, testConfigJsonize) {
    string schemaStr = "{\"start_token_id\": 224, \"end_token_id\": 1, \"prefix_dict\": {\"1_2\": [3,4,5], \"1_2_3\": [3,4,5]}}";
...
TEST_F(DFAUtilTest, testReloadFile) {
    std::string file_path = "./maga_transformer/cpp/utils/test/gir_prefix_dict.json";
