...
#define TIMEUTILITY_RECORD_CODE_TIME(code)                                                                             \
    ({                                                                                                                 \
        const auto startTime = maga_transformer::TimeUtility::currentTime();                                           \
        code;                                                                                                          \
        const auto latency = maga_transformer::TimeUtility::currentTime() - startTime;                                 \
        latency;                                                                                                       \
    })
