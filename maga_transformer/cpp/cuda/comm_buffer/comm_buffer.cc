...
CommBuffer::CommBuffer(const NcclParam& nccl_para,
    ...
    RTP_LLM_LOG_DEBUG("buffer_shape[0] %zu, buffer_shape[1] %zu, getTypeSize(buffer_dtype) %zu, buffer_bytes %zu, tp_size %d", buffer_shape[0], buffer_shape[1], getTypeSize(buffer_dtype), buffer_bytes, tp_size);
