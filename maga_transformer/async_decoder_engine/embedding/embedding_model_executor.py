...
class EmbeddingModelExecutor(object):
    def __init__(self, model: BaseModel, config: GptInitModelParameters):
        ...
        self.embedding_op_ = EmbeddingOp(self.model_.word_embedding._emb, 
                                         self.model_.position_encoding._emb if self.model_.position_encoding is not None else None,
                                         self.model_.token_type_embeddings._emb if self.model_.token_type_embeddings is not None else None,
