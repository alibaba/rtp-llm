...
def upload_to_oss(prec, model_size):
    ...
    task_info = "_".join([device, prec, model_size, "config.ini"])
    
    dest_path = oss_out_path + "/" + task_info
...
if __name__ == '__main__':
    ...
    parser.add_argument('--upload_to_oss', type=bool, default=True)
    ...
    if args.upload_to_oss:
        upload_to_oss(args.prec, args.model_size)
