...
class BertWeightInfo(ModelDeployWeightInfo):
    ...
    def _get_weight_info(self):
        if self._quant_algo.isSmoothQuant():
            return self._get_smooth_quant_weight_info()        
        else:
            return self._get_hf_weight_info()

    def _get_smooth_quant_weight_info(self):
        ...
        layer_weights = [
            ...
            WeightInfo(W.ffn_s2, [CkptWeightInfo(self._smooth_quant_names.FFN_OUTPUT_DENSE_S)], functools.partial(expand_scale, hidden_size=self._inter_size)),
