...
This code is ported from FastChat (https://github.com/lm-sys/FastChat/blob/bb8aae5/fastchat/conversation.py)

While we really wanted to import fastchat as a dependency,
its current version (0.2.35) requires pydantic < 2.0.0, meanwhile our project requires pydantic 2.x,
which is not compatible with each other.

We appreciate the authors of FastChat a lot for their great work.

TODO(wangyin.yx): import fastchat as a dependency in the future if possible.
"""
