...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<PyAttentionInputs>(m, "PyAttentionInputs")
        ...
        .def_readwrite("request_ids_host", &PyAttentionInputs::request_ids_host)
        .def_readwrite("generation_epochs_host", &PyAttentionInputs::generation_epochs_host)
        .def_readwrite("kda_shadow_keys_host", &PyAttentionInputs::kda_shadow_keys_host)
        .def_readwrite("kda_shadow_block_ids_host", &PyAttentionInputs::kda_shadow_block_ids_host)
        .def_readwrite("kda_shadow_kernel_block_ids_host", &PyAttentionInputs::kda_shadow_kernel_block_ids_host)
        .def_readwrite("kda_shadow_group_id", &PyAttentionInputs::kda_shadow_group_id)
        ...
        .def_readwrite("kv_cache_layer_to_group_host", &PyAttentionInputs::kv_cache_layer_to_group_host)
