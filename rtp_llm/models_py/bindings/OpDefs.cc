...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<PyAttentionInputs>(m, "PyAttentionInputs")
        ...
        .def_readwrite("coordinated_request_count", &PyAttentionInputs::coordinated_request_count)
        ...
        .def_readwrite("coordinated_token_count", &PyAttentionInputs::coordinated_token_count)
