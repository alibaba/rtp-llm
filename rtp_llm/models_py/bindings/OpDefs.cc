...
void registerPyOpDefs(pybind11::module& m) {
    ...
    pybind11::class_<KVCache>(m, "KVCache")
        ...
        .def_readonly("block_generations_by_layer", &KVCache::block_generations_by_layer)
    ...
    pybind11::class_<PyAttentionInputs>(m, "PyAttentionInputs")
        ...
        .def_readwrite("is_draft_extend", &PyAttentionInputs::is_draft_extend)
        ...
        .def_readwrite("mtp_indexer_seed_rows", &PyAttentionInputs::mtp_indexer_seed_rows)
