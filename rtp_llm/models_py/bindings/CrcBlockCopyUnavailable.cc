...
CrcBlockCopyResult CrcBlockCopy::gather(size_t, const std::vector<CrcBlockCopyTile>&, bool) {
...
CrcBlockCopyResult CrcBlockCopy::scatter(size_t, const std::vector<CrcBlockCopyTile>&) {
    throw std::runtime_error("memory cache block CRC backend unavailable");
}
}  // namespace rtp_llm
