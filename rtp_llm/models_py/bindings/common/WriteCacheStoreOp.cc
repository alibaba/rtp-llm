...
void WriteCacheStoreOp(const torch::Tensor&                         input_lengths,
    ...
    auto run = [captured_input_lengths,
        ...
        const auto   tokens_it = captured_cache_store.tokens_per_block_by_group.find(captured_kv_cache.tag);
        const size_t store_tokens_per_block = tokens_it != captured_cache_store.tokens_per_block_by_group.end() ?
                                                  tokens_it->second :
        ...
        inputs.tokens_per_block_by_group                        = captured_cache_store.tokens_per_block_by_group;
        inputs.kv_block_stride_bytes_by_group                   = captured_cache_store.kv_block_stride_bytes_by_group;
        inputs.kv_scale_stride_bytes_by_group                   = captured_cache_store.kv_scale_stride_bytes_by_group;
        inputs.kv_block_transfer_bytes_by_group                 = captured_cache_store.kv_block_transfer_bytes_by_group;
        inputs.kv_scale_transfer_bytes_by_group                 = captured_cache_store.kv_scale_transfer_bytes_by_group;
        ...
        inputs.tokens_per_block_by_group[captured_kv_cache.tag] = layer_tokens_per_block;
