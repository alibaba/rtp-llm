...
#if USING_CUDA
template void invokePackedMaskLogits<float>(float*,
                                            const int32_t*,
                                            const int32_t*,
                                            int,
                                            int,
                                            ...
                                            int,
                                            cudaStream_t);
template void invokePackedMaskLogits<half>(half*,
                                           const int32_t*,
                                           const int32_t*,
                                           int,
                                           int,
                                           ...
                                           int,
                                           cudaStream_t);
template void invokePackedMaskLogits<__nv_bfloat16>(__nv_bfloat16*,
                                                    const int32_t*,
                                                    const int32_t*,
                                                    int,
                                                    int,
