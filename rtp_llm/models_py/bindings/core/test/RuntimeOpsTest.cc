...
class RuntimeOpsTest: public ::testing::Test {
protected:
...
TEST_F(RuntimeOpsTest, testCopyH2D) {
...
TEST_F(RuntimeOpsTest, testCopyD2H) {
    auto       src = torch::randn({16}, torch::kCUDA);
...
TEST_F(RuntimeOpsTest, testBatchCopyD2D) {
    ...
    ASSERT_NO_THROW(runtimeBatchCopy(params));
    runtimeSyncAndCheck();
    ASSERT_TRUE(torch::equal(src1, dst1));
    ASSERT_TRUE(torch::equal(src2, dst2));
}

TEST_F(RuntimeOpsTest, testBatchCopyH2D) {
...
TEST_F(RuntimeOpsTest, testBatchCopyD2H) {
...
TEST_F(RuntimeOpsTest, testGetGpuExecStatus) {
...
TEST_F(RuntimeOpsTest, testRuntimeMaskLogits) {
...
TEST_F(RuntimeOpsTest, testRuntimeApplyPackedMaskLogitsUsesCompactRowMapping) {
...
TEST_F(RuntimeOpsTest, testRuntimeApplyPackedMaskLogitsSupportsSingleRowIdentityMapping) {
    constexpr int64_t vocab_size = 35;
...
TEST_F(RuntimeOpsTest, testRuntimeApplyPackedMaskLogitsSkipsOutOfRangeRows) {
...
TEST_F(RuntimeOpsTest, testRuntimeApplyPackedMaskLogitsCopiesBackToNonContiguousInput) {
    constexpr int64_t vocab_size = 4;
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreRejectsUndefinedRequestId) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreMlaBf16PhysicalViewUsesExplicitStride) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreMlaFp8PackedPhysicalViewUsesExplicitStride) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreMhaKernelViewKeepsExplicitKvAndScaleStrides) {
    constexpr size_t physical_block_num         = 4;
    constexpr size_t physical_tokens_per_block  = 8;
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreSharedPoolUsesPhysicalBlockStrideInsteadOfLayerViewStride) {
    constexpr size_t physical_block_num        = 4;
    constexpr size_t physical_tokens_per_block = 8;
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreCpStateSendsCompleteRankLocalRow) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreCpRoundRobinUsesCanonicalKeyCount) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreFailureBufferContainsEveryBlockKey) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreSuccessDoesNotLogBlockKeys) {
...
TEST_F(RuntimeOpsTest, testLoadContextFailureDebugInfoContainsEveryBlockKey) {
    auto cache_store          = std::make_shared<MockCacheStore>();
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreTag_LinearGroup) {
    auto                    cache_store = std::make_shared<MockCacheStore>();
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreTag_FullGroup) {
    auto                    cache_store = std::make_shared<MockCacheStore>();
    auto                    inputs      = makePyCacheStoreInputs(/*tokens_per_block=*/2, /*block_num=*/3);
    auto                    config      = makeCacheConfig(/*tokens_per_block=*/2,
                                  /*physical_kv_stride=*/64,
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreSameLayerRoutesByTag) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreRejectsNonLocalBlockTable) {
    auto cache_store               = std::make_shared<MockCacheStore>();
    auto inputs                    = makePyCacheStoreInputs(/*tokens_per_block=*/2, /*block_num=*/3);
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreTag_LocalOffset) {
    auto                    cache_store = std::make_shared<MockCacheStore>();
    auto                    inputs      = makePyCacheStoreInputs(/*tokens_per_block=*/2, /*block_num=*/3);
    auto                    config      = makeCacheConfig(/*tokens_per_block=*/2,
                                  /*physical_kv_stride=*/64,
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreSkipsNullPhysicalBlocks) {
    auto cache_store               = std::make_shared<MockCacheStore>();
    auto inputs                    = makePyCacheStoreInputs(/*tokens_per_block=*/2, /*block_num=*/3);
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreUsesDecoderOffsetForContextBlockRow) {
    auto cache_store               = std::make_shared<MockCacheStore>();
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreUsesCacheModelIdInKeyNamespace) {
...
TEST_F(RuntimeOpsTest, testWriteCacheStoreReadsNonContiguousHostMetadata) {
    auto cache_store             = std::make_shared<MockCacheStore>();
    auto inputs                  = makePyCacheStoreInputs(/*tokens_per_block=*/2, /*block_num=*/1);
