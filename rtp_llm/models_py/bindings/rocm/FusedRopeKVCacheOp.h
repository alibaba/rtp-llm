...
public:
    FusedRopeKVCachePrefillOp(const ModelConfig& model_config, const ParallelismConfig& parallelism_config, int layer_num, const HWKernelConfig& hw_kernel_config);
...
public:
    FusedRopeKVCacheDecodeOp(const ModelConfig& model_config, const ParallelismConfig& parallelism_config, int layer_num, const HWKernelConfig& hw_kernel_config);
    CKAttnPtr     prepare(torch_ext::PyAttentionInputs attn_inputs);
