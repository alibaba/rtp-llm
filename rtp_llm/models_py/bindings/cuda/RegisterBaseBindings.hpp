...
void registerBasicCudaOps(py::module &rtp_ops_m) {
    rtp_ops_m.def("rmsnorm", &rmsnorm, "RMSNorm kernel",
        py::arg("output"),
        py::arg("input"),
        py::arg("weight"),
        py::arg("eps"),
    ...
    rtp_ops_m.def("fused_add_rmsnorm", &fused_add_rmsnorm, "Fused Add RMSNorm kernel",
        py::arg("input"),
        py::arg("residual"),
        py::arg("weight"),
        py::arg("eps"),
    ...
    rtp_ops_m.def("silu_and_mul", &silu_and_mul, "SiLU and Multiply kernel",
        py::arg("output"),
        py::arg("input"),
        py::arg("cuda_stream") = 0);

    rtp_ops_m.def("fused_qk_rmsnorm", &FusedQKRMSNorm, "Fused QK RMSNorm kernel",
        py::arg("IO"),
        py::arg("q_gamma"),
        py::arg("k_gamma"),
    ...
    rtp_ops_m.def("fused_add_layernorm", &fused_add_layernorm, "Fused Add LayerNorm kernel",
        py::arg("input"),
        py::arg("residual"),
        py::arg("bias"),
        py::arg("weight"),
