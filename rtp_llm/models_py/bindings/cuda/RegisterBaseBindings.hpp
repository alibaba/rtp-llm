...
void registerCustomAllReduceOps(py::module& rtp_ops_m) {
    rtp_ops_m.def("custom_ar_init",
                  &rtp_llm::custom_ar_init,
                  py::arg("ipc_ptrs"),
                  py::arg("rank_data"),
                  py::arg("rank"),
                  py::arg("full_nvlink"));
    rtp_ops_m.def("custom_ar_all_reduce",
                  &rtp_llm::custom_ar_all_reduce,
                  py::arg("fa"),
                  py::arg("inp"),
                  py::arg("out"),
                  py::arg("reg_buffer"),
    ...
    rtp_ops_m.def("custom_ar_register_buffer", &rtp_llm::custom_ar_register_buffer, py::arg("fa"), py::arg("ipc_ptrs"));
    rtp_ops_m.def("custom_ar_get_graph_buffer_ipc_meta", &rtp_llm::custom_ar_get_graph_buffer_ipc_meta, py::arg("fa"));
    rtp_ops_m.def("custom_ar_register_graph_buffers",
                  &rtp_llm::custom_ar_register_graph_buffers,
                  py::arg("fa"),
                  py::arg("handles"),
                  py::arg("offsets"));
}
