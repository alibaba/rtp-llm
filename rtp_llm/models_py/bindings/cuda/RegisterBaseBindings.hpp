...
void registerBasicCudaOps(py::module& rtp_ops_m) {
    ...
    rtp_ops_m.def("dsv4_cp_distributed_prefill_attention",
                  &dsv4_cp_distributed_prefill_attention,
                  ...
                  py::arg("window_size"),
                  py::arg("compressed_topk"),
                  py::arg("compressed_region_width") = -1,
                  py::arg("cp_rank") = 0,
                  py::arg("cp_size") = 1,
                  py::arg("comm_ptr") = 0,
                  py::arg("buffer_handle") = -1,
                  py::arg("signal_handle") = -1,
                  py::arg("per_rank_buffer_bytes") = 0,
                  py::arg("rank_offsets") = std::vector<int64_t>{},
                  py::arg("swa_k") = py::none(),
                  py::arg("swa_k_cache") = py::none(),
                  py::arg("swa_slot_mapping") = py::none(),
                  py::arg("symm_buffer") = py::none(),
                  py::arg("symm_buffer_ptrs_dev") = 0,
                  py::arg("symm_signal_pad_ptrs_dev") = 0,
                  py::arg("symm_handle") = py::none(),
                  py::arg("compressor_kv") = py::none(),
                  py::arg("compressor_score") = py::none(),
                  py::arg("compressor_ape") = py::none(),
                  py::arg("compressor_positions") = py::none(),
                  py::arg("compressor_state_cache") = py::none(),
                  py::arg("compressor_state_slots") = py::none(),
                  py::arg("compressor_ratio") = 0,
                  py::arg("compressor_token_to_req") = py::none(),
                  py::arg("compressor_state_block_table") = py::none(),
                  py::arg("compressor_norm_weight") = py::none(),
                  py::arg("compressor_cos_sin_cache") = py::none(),
                  py::arg("compressor_kv_cache") = py::none(),
                  py::arg("compressor_kv_slots") = py::none(),
                  py::arg("compressor_seq_start") = 0,
                  py::arg("compressor_disable_raw_path") = false,
                  py::arg("compressor_rms_norm_eps") = 1.0e-6,
                  py::arg("compressor_head_dim") = 0,
                  py::arg("compressor_rope_head_dim") = 0,
                  py::arg("compressor_overlap") = false,
                  py::arg("compressor_state_tokens_per_block") = 0,
                      py::arg("compressor_seq_start_per_req") = py::none(),
                      py::arg("compressor_cu_seq_per_req") = py::none(),
                      py::arg("compressor_unpad_restore") = py::none(),
                      py::arg("csa_indexer_compressor_kv") = py::none(),
                      py::arg("csa_indexer_compressor_score") = py::none(),
                      py::arg("csa_indexer_compressor_ape") = py::none(),
                      py::arg("csa_indexer_compressor_positions") = py::none(),
                      py::arg("csa_indexer_compressor_state_cache") = py::none(),
                      py::arg("csa_indexer_compressor_state_slots") = py::none(),
                      py::arg("csa_indexer_compressor_ratio") = 0,
                      py::arg("csa_indexer_compressor_token_to_req") = py::none(),
                      py::arg("csa_indexer_compressor_state_block_table") = py::none(),
                      py::arg("csa_indexer_compressor_norm_weight") = py::none(),
                      py::arg("csa_indexer_compressor_cos_sin_cache") = py::none(),
                      py::arg("csa_indexer_compressor_kv_cache") = py::none(),
                      py::arg("csa_indexer_compressor_kv_slots") = py::none(),
                      py::arg("csa_indexer_compressor_seq_start") = 0,
                      py::arg("csa_indexer_compressor_disable_raw_path") = false,
                      py::arg("csa_indexer_compressor_rms_norm_eps") = 1.0e-6,
                      py::arg("csa_indexer_compressor_head_dim") = 0,
                      py::arg("csa_indexer_compressor_rope_head_dim") = 0,
                      py::arg("csa_indexer_compressor_overlap") = false,
                      py::arg("csa_indexer_compressor_state_tokens_per_block") = 0,
                      py::arg("csa_indexer_compressor_seq_start_per_req") = py::none(),
                      py::arg("csa_indexer_compressor_cu_seq_per_req") = py::none(),
                      py::arg("csa_indexer_compressor_unpad_restore") = py::none(),
                      py::arg("csa_indexer_k_cache") = py::none(),
                  py::arg("csa_indexer_weights") = py::none(),
                  py::arg("csa_indexer_cu_lens") = py::none(),
                  py::arg("csa_indexer_k_pool") = py::none(),
                  py::arg("csa_indexer_block_table") = py::none(),
                  py::arg("csa_indexer_seq_lens") = py::none(),
                  py::arg("attention_cmp_k_cache") = py::none(),
                  py::arg("attention_cmp_cu_lens") = py::none(),
                  py::arg("attention_cmp_k_pool") = py::none(),
                  py::arg("attention_cmp_block_table") = py::none(),
                  py::arg("attention_cmp_seq_lens") = py::none(),
                  py::arg("attention_swa_k_cache") = py::none(),
                  py::arg("attention_swa_cu_lens") = py::none(),
                  py::arg("attention_swa_k_pool") = py::none(),
                  py::arg("attention_swa_slot_mapping") = py::none(),
                  py::arg("attention_swa_gather_lens") = py::none(),
                  py::arg("kv_unpad_restore") = py::none(),
                  py::arg("kv_cu_lens") = py::none());
