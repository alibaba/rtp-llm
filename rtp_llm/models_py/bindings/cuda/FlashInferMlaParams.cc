...
void registerPyFlashInferMlaParams(pybind11::module& m) {
    pybind11::class_<rtp_llm::MlaParamsBase, std::shared_ptr<rtp_llm::MlaParamsBase>>(m, "MlaParamsBase").def(pybind11::init<>());
    pybind11::class_<rtp_llm::FlashInferMlaAttnParams, std::shared_ptr<rtp_llm::FlashInferMlaAttnParams>, rtp_llm::MlaParamsBase>(m, "FlashInferMlaAttnParams")
        .def(pybind11::init<>())
        .def(
            "fill_mla_params",
