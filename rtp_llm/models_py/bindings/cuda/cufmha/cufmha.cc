...
void cufmha::runOpenSourceFmhaPaged(void*      q,
    ...
    if (rtp_llm::fmha::ProfilingInterface::Instance(fmha_config).get_op_info()) {
    ...
    rtp_llm::fmha::ProfilingInterface::Instance(fmha_config).instrument(true, fmha_prof_params);
    try {
    ...
    rtp_llm::fmha::ProfilingInterface::Instance(fmha_config).instrument(false, fmha_prof_params);
    check_cuda_error();
}
