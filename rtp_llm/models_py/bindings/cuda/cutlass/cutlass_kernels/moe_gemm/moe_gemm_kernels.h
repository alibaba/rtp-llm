...
struct HopperGroupedGemmInput {
    ...
    void setFinalizeFusionParams(void*          final_output,
                                 float const*   router_scales,
                                 int64_t const* expert_first_token_offset,
                                 int const*     source_token_index,
                                 void const*    bias,
                                 int            hidden_size,
...
public:
    ...
    void moeGemmBiasAct(T const*                              A,
                        WeightType const*                     B,
                        ScaleBiasType const*                  weight_scales,
                        ScaleBiasType const*                  weight_zeros,
                        int                                   group_size,
                        ScaleBiasType const*                  biases,
    ...
    std::vector<cutlass_extensions::CutlassGemmConfig> getValidConfigs(T const*             A,
                                                                       WeightType const*    B,
                                                                       ScaleBiasType const* weight_scales,
                                                                       ScaleBiasType const* weight_zeros,
                                                                       int                  group_size,
    ...
    cutlass_extensions::CutlassGemmConfig getChosenConfig(int64_t        total_rows,
                                                          int64_t        gemm_n,
                                                          int64_t        gemm_k,
                                                          int            num_experts,
                                                          bool           use_fused_moe,
