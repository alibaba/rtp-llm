...
void dispatchMoeGemmSelectBiasSM90(HopperGroupedGemmInput hopper_input,
                                   int                    num_experts,
    ...
    TLLM_CHECK_WITH_INFO(workspace_size || occupancy || hopper_input.isValid(),
    ...
    auto func = kernels::cutlass_kernels::sm90_generic_moe_gemm_kernelLauncher<T,
                                                                               WeightType,
                                                                               OutputType,
                                                                               EpilogueTag,
                                                                               FUSION,
...
template<typename T,
         ...
         EpilogueFusion FUSION,
         typename TileShape>
void dispatchMoeGemmSelectClusterShapeSM90(HopperGroupedGemmInput                hopper_input,
                                           int                                   num_experts,
...
void dispatchMoeGemmSelectTileShapeSM90(HopperGroupedGemmInput                hopper_input,
                                        int                                   num_experts,
                                        cutlass_extensions::CutlassGemmConfig gemm_config,
                                        int                                   multi_processor_count,
                                        cudaStream_t                          stream,
...
size_t calcMaxWorkspaceSizeSM90(int                                   num_experts,
                                cutlass_extensions::CutlassGemmConfig gemm_config,
                                int                                   multi_processor_count) {
    size_t count;
