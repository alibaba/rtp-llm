...
void sm80_generic_fused_moe_gemm_kernelLauncher(ElementType_ const*       A,
                                                CutlassWeightType_ const* B,
    ...
    using GemmType                 = fused_moe::Fused_Moe_Kernel_sm80<ElementType_,
                                                                      CutlassWeightType_,
                                                                      ElementType_,
                                                                      MaxTileM_,
                                                                      TileN_,
    ...
    Arguments args{{const_cast<ElementType_*>(A),
    ...
    if (GemmType::kSmemSize >= (48 << 10)) {
        ...
        TLLM_CHECK_WITH_INFO(result == cudaSuccess,
                             "Fail to set the max smem size to " + std::to_string(GemmType::kSmemSize)
