// sglang: 372507649d43d50dc8d109eaeafa622f980ee473
...
template<typename T>
typename T::Gemm::Arguments args_from_options(at::Tensor&       D,
                                              at::Tensor const& A,
                                              at::Tensor const& B,
    ...
    typename T::Gemm::Arguments arguments{cutlass::gemm::GemmUniversalMode::kGemm,
                                          {m, n, k, 1},
                                          {// Mainloop arguments
...
typename Gemm::Arguments args_from_options_sm120(at::Tensor&          D,
                                                 at::Tensor const&    A,
                                                 at::Tensor const&    B,
                                                 at::Tensor const&    A_sf,
                                                 at::Tensor const&    B_sf,
...
void cutlassFp4GemmDispatch(torch::Tensor&       D,
...
// Dispatch function to select appropriate config based on M
template<>
void cutlassFp4GemmDispatch<float>(torch::Tensor&       D,
                                   torch::Tensor const& A,
                                   torch::Tensor const& B,
                                   torch::Tensor const& A_sf,
                                   torch::Tensor const& B_sf,
...
void cutlass_fp4_bf16_gemm_dispatch_sm120(torch::Tensor&       D,
                                          torch::Tensor const& A,
                                          torch::Tensor const& B,
                                          torch::Tensor const& A_sf,
                                          torch::Tensor const& B_sf,
...
void cutlass_fp4_f16_gemm_dispatch_sm120(torch::Tensor&       D,
                                         torch::Tensor const& A,
                                         torch::Tensor const& B,
                                         torch::Tensor const& A_sf,
                                         torch::Tensor const& B_sf,
...
#else
template<typename T>
void cutlassFp4GemmDispatch(at::Tensor&       D,
                            at::Tensor const& A,
                            at::Tensor const& B,
                            at::Tensor const& A_sf,
                            at::Tensor const& B_sf,
...
void cutlass_scaled_fp4_mm_sm100a_sm120a(torch::Tensor&       D,
                                         torch::Tensor const& A,
                                         torch::Tensor const& B,
                                         torch::Tensor const& A_sf,
                                         torch::Tensor const& B_sf,
