...
template<typename T>
void invokeFP4Quantization(int          m,
                           int          n,
                           T const*     input,
                           float const* SFScale,
                           int64_t*     output,
...
template void invokeFP4Quantization(int          m,
                                    int          n,
                                    half const*  input,
                                    float const* SFScale,
                                    int64_t*     output,
    ...
    switch (input.scalar_type()) {
        case torch::kHalf: {
            ...
            invokeFP4Quantization(
                m, n, input_ptr, input_sf_ptr, output_ptr, sf_out, useUE8M0, multiProcessorCount, stream);
            break;
        }
