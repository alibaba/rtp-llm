...
struct Fused_Moe_Kernel_sm80 {
    ...
    using BaseKernelTraits  = Fused_Moe_Kernel_traits_sm80<ElementInput,
                                                           ElementWeight,
                                                           ElementOutput,
                                                           kMaxTileM,
                                                           kTileN,
    ...
    using BaseKernelTraits_m16    = Fused_Moe_Kernel_traits_sm80<ElementInput,
                                                                 ElementWeight,
                                                                 ElementOutput,
                                                                 16,
                                                                 kTileN,
    ...
    static Params to_underlying_arguments(Arguments const& args) {
        return {{args.routine_args.ptr_input,
                 args.routine_args.ptr_fc1,
                 args.routine_args.ptr_bias,
                 args.routine_args.ptr_output,
                 args.routine_args.total_tokens_including_expert,
                 args.routine_args.gemm_n,
                 args.routine_args.gemm_k,
                 args.routine_args.num_expert,
...
#define ROUTINE_PATH(kTileM_size)                                                                                      \
    {                                                                                                                  \
        ...
        using RoutineTraits  = Fused_Moe_Kernel_routine_sm80<ElementInput,                                             \
                                                             ElementWeight,                                            \
                                                             ElementOutput,                                            \
                                                             kTileM,                                                   \
                                                             kTileN,                                                   \
