#include "dsv4_persistent_topk.h"
...
void dsv4_persistent_topk(const torch::Tensor& scores,
    ...
    TORCH_CHECK(k == 512 || k == 1024 || k == 2048,
                "dsv4_persistent_topk supports K=512, 1024, or 2048");
    ...
    TORCH_CHECK(error == cudaSuccess,
                "DSv4 SGLang TopK launch failed: ", cudaGetErrorString(error));
}
