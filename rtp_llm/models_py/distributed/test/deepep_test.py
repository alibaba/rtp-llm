...
class DeepEPTest(TestCase):
    ...
    NUM_EXPERTS = [160]
    NUM_TOPK = [8]
    NORMAL_NUM_TOKENS = [4095]
    LOW_LATENCY_NUM_TOKENS = [127]
    PEO_LEVELS = [3]
    NUM_PEO_ROUNDS = [2]
    DEEP_EP_NUM_SM = [4]
    ...
    def _run_deepep_normal_test(rank: int, num_ranks: int, args: Dict[str, Any]):
        ...
        (
            ...
            num_tokens, hidden_size, num_experts, num_topk, rank
        )
    ...
    def _run_deepep_low_latency_peo_overlap_test(
        ...
        num_comm_sms = args.get("deep_ep_num_sm", 4)
        num_device_total_sms = get_num_device_sms()
