...
def init_distributed_environment(
    ...
    When node_comm_info is provided, NCCL ip and th_nccl_port are taken from it
    instead of from parallelism_config.

    Args:
        parallelism_config: Configuration for parallelism setup (sizes, ranks, etc.)
        node_comm_info: Optional NodeCommInfo; when set, ip and th_nccl_port
            are taken from here instead of parallelism_config.
    ...
    ip = node_comm_info.ip
    port = node_comm_info.th_nccl_port
