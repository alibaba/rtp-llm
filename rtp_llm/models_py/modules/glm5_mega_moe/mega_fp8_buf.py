"""Symm-mem buffer cache + capability gates for DeepGEMM FP8xFP8 Mega MoE."""
...
def get_or_create_mega_buf_fp8(
    ...
    """Get or create the shared symmetric memory buffer for FP8xFP8 Mega MoE."""
    import deep_gemm
...
def _mega_moe_fp8_unavailable_reason() -> str | None:
    """Return None when FP8xFP8 Mega MoE can run."""
    try:
        import deep_gemm
...
def mega_moe_fp8_enabled() -> bool:
    """Default on when fp8_fp8 Mega MoE availability holds."""
