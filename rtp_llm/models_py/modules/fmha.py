...
try:
    ...
    class FlashInferPythonPrefillImpl(FMHAPrefillImplBase):

        def __init__(
            self, config: GptInitModelParameters, attn_inputs: PyAttentionInputs
        ) -> None:
            super().__init__(
                FlashInferPythonPrefillOp(config.gpt_init_params),
...
try:
    ...
    class FlashInferPythonDecodeImpl(FMHADecodeImplBase):
