...
from rtp_llm.models_py.modules import QKRMSNorm, QKRMSNormTorch


class QKRMSNormTest(TestCase):
    ...
    def _run_qkrmsnorm_test(
        ...
        self.assertTrue(torch.allclose(qkrmsnorm_torch(input), qkrmsnorm(input), atol=1e-2, rtol=1e-2))

    def test_qkrmsnorm(self):
        for params in itertools.product(
            ...
            with self.subTest(
                ...
                self._run_qkrmsnorm_test(*params)
