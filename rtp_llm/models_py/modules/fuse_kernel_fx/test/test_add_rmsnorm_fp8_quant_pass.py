...
class AddRmsnormFp8QuantPassTest(unittest.TestCase):
    def test_same_graph_fusion_uses_dual_output_with_copy_back(self):
        ...
        # Mutation contract: copy_ writes normed bf16 back into hidden_states
        self.assertIn(
            "copy_", [n.target for n in gm.graph.nodes if n.op == "call_method"]
        )
    ...
    def test_unsupported_hidden_dim_skips(self):
        ...
        self.assertNotIn("fused_add_rmsnorm_fp8_quant_with_bf16_output", names)
