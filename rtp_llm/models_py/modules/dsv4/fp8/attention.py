...
from rtp_llm.models_py.modules.dsv4.fp8._kv_cache_utils import (
    require_physical_pool_tokens_per_block as _dsv4_physical_pool_tokens_per_block,
...
class AttentionFP8(nn.Module):
    ...
    def _pool_view(self, attn_type: int) -> Optional[torch.Tensor]:
        ...
        if not self._kv_cache.has_layer_cache(self.layer_id, attn_type_tag):
            return None
    ...
    def _set_compressor_pool_context(self) -> None:
        ...
        if self.compressor is not None:
            ...
            kv_owner_tpb = (
                _dsv4_physical_pool_tokens_per_block(
                    self._kv_cache, region=kv_at
                )
        ...
        if self.indexer is not None:
            ...
            kv_owner_tpb = _dsv4_physical_pool_tokens_per_block(
                self._kv_cache, region=INDEXER_KV
            )
