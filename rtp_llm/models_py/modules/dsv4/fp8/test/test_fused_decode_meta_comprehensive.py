...
# Pre-register kv_cache_utils so that fused module's internal import resolves.
# The old int-id attn_type.py shim is gone: tags now live in kv_cache_utils.py.
