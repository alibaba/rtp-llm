...
class SwaStreamingOutputProjectionTest(unittest.TestCase):
    ...
    def test_single_chunk_passes_full_tensors_without_slicing(self) -> None:
        ...
        # Alias validation must not construct a second workspace view.
        workspace.prefill_q = MagicMock(  # type: ignore[method-assign]
            side_effect=AssertionError("unexpected prefill_q view")
        )
