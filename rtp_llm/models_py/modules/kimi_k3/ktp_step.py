...
def coordinate_ktp_step(
    *,
    ...
    """AllGather step metadata and perform one compact host transfer."""
    ...
    # Coordination stays outside CUDA Graph; all later planning is host-only.
    return build_ktp_step_plan(gathered_d.cpu().tolist(), capture_buckets)
