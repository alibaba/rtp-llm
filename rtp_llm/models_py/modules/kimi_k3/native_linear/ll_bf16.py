...
class LLBf16Gemm:
    ...
    def _fake_gemm_tensors(*, M, K, N, divisibility: int):
        ...
        def make_fake_tensor(dtype, shape, divisibility):
            # Match upstream's compile-only row-major dynamic-stride descriptor.
            return cute.runtime.make_fake_tensor(
                dtype, shape,
                stride=(cute.sym_int64(divisibility=divisibility), 1),
