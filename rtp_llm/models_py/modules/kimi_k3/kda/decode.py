...
class KimiK3KDADecode(nn.Module):
    ...
    def _cache_context(
        ...
        """Return the cache-manager-owned paged Decode state."""

        sequence_lengths_plus_one = attention_inputs.sequence_lengths_plus_1_d
    ...
    def forward(
        ...
        *,
        ...
        cache = self._cache_context(kv_cache, attention_inputs)
        if is_target_verify:
