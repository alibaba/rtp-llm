...
from rtp_llm.models_py.modules.rocm.moe.routers.deepep_low_latency_router import (
...
def _init_router(rank: int, use_fp8: bool):
    ...
    os.environ["LOW_LATENCY_OPTIMIZE"] = "0"
...
def _run_deepep_low_latency_router_test(rank: int, use_fp8: bool):
    ...
    int_mask = (2**32) - 1
    hidden_states = (
        torch.randn((dp_size, num_token_per_rank, hidden_size))
        .to(torch.bfloat16)
        .cuda()
    )
