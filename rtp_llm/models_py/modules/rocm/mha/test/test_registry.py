...
from rtp_llm.models_py.modules.rocm.mha.aiter import AiterDecodeImplAsm, AiterDecodeImplNonAsm, AiterPrefillImpl
...
class TestRocmFMHARegistry(unittest.TestCase):
    def test_aiter_registered(self):
        ...
        self.assertIn(AiterDecodeImplAsm, DECODE_MHA_IMPS)
        self.assertIn(AiterDecodeImplNonAsm, DECODE_MHA_IMPS)
