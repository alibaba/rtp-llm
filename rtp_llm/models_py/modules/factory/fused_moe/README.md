...
- **Executor types**: `BATCHED_TRITON` (0) < `DEEPGEMM_CONTINUOUS` (1) < `DEEPGEMM_MASKED`/`FUSED_MOE` (2) < `CUTLASS_FP8` (3) < `CUTLASS_BATCHED_FP8` (4) < `CUTLASS_W4A8_INT4_PER_CHANNEL` (5) < `CUTLASS_BATCHED_W4A8_INT4_PER_CHANNEL` (6) < `TRTLLM_FP4` (7) < `CUTEDSL_FP4` (8) < `SM120_FP8_GROUPED` (9) < `B12X_FP4` (10)
