...
class MoEConfigAdapter:
    ...
    def __init__(
        ...
        # MoE uses physical TP topology for expert partitioning and strategy
        # selection. get_attn_tp_size() returns 1 when CP is enabled, which
        # would break PureTpRouter selection (is_tp_equal_ep fails).
