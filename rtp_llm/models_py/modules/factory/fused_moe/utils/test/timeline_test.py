...
class TimelineCheckerTest(unittest.TestCase):
    ...
    def test_forbidden_kernel_inside_hot_range_fails(self):
        path = self._timeline(
            [
                {
                    "ph": "X",
    ...
    def test_forbidden_kernel_outside_hot_range_is_ignored(self):
        path = self._timeline(
            [
                {
                    "ph": "X",
                ...
                {"ph": "X", "name": "deep_gemm", "cat": "kernel", "ts": 15, "dur": 2},
                {
                    "ph": "X",
                    "name": "aten::copy_kernel",
                    "cat": "kernel",
