...
class CutedslFp4ExecutorTestBase:
    ...
    def _generate_payload_and_weights(
        ...
        weights = {
            W.moe_gate_up: w1_quantized,
            W.moe_down: w2_quantized,
            W.moe_gate_up_s: w1_blockscale,
            W.moe_down_s: w2_blockscale,
            W.moe_gate_up_s2: 1 / w1_global_scale,
            W.moe_down_s2: 1 / w2_global_scale,
            W.moe_gate_up_i_s: input_global_scale,
            W.moe_down_i_s: a2_global_scale,
        }
        return (
            payload,
            weights,
    ...
    def test_cutedsl_fp4_executor(self):
        ...
        input_global_scale = weights[W.moe_gate_up_i_s]
