...
class KVCacheWriteOp:
    ...
    def forward(
        ...
        if kv_cache is not None:
            ...
            # flashinfer.page.append_paged_kv_cache is a raw copy and does not
            # cast dtypes. RoPE can produce BF16/FP16 K/V while an FP8 KV cache
            # stores e4m3, so cast before appending to avoid corrupt cache bytes.
