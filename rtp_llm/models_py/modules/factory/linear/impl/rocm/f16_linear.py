...
from rtp_llm.utils.swizzle_utils import is_swizzled
...
class RocmF16LinearWithSwizzle(RocmF16LinearBase):
    ...
    def can_handle(
        ...
        return weight_scales is None and is_swizzled(weight)
...
class RocmF16LinearNoSwizzle(RocmF16LinearBase):
    ...
    def can_handle(
        ...
        return weight_scales is None and not is_swizzled(weight)
