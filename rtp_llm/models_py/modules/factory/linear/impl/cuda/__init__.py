...
from rtp_llm.models_py.utils.arch import get_sm, is_cuda, is_hip

# ROCm registers RocmF16Linear*. CUDA and PPU share CudaF16Linear, so keep
# the F16 fallback off HIP only — not behind is_cuda(), or PPU has no strategy.
if not is_hip():
