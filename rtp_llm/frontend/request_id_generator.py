...
def generate_request_id(
    ...
    # Note: sequence is derived from a global counter (not per-millisecond reset).
    # This is safe as long as QPS < 4,096,000 per machine (~4M QPS), which is
    # well beyond LLM inference workloads.
