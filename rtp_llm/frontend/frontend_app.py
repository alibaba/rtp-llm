...
class FrontendApp(object):
    def __init__(
        ...
        logging.info(
            ...
            f"server_port = {g_worker_info.server_port}, rpc_server_port = {g_worker_info.rpc_server_port}, frontend_server_id = {self.server_config.frontend_server_id}"
        )
        self.grpc_client = GrpcClientWrapper("localhost", g_worker_info.rpc_server_port)
