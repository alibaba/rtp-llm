...
public class OptimizerInstanceParams {
    ...
    public boolean matchesRemote(OptimizerGetInstanceResponse remote) {
        ...
        if (!matchesOptimizerStateInfo(remote.getOptimizerStateInfo())) return false;
    ...
    private boolean matchesOptimizerStateInfo(OptimizerStateInfo remoteStateInfo) {
        if (this.optimizerStateInfo == null || remoteStateInfo == null) {
            return this.optimizerStateInfo == remoteStateInfo;
        }
        return Objects.equals(
                        nullToEmpty(this.optimizerStateInfo.getFullLocationSpecGroupName()),
                        nullToEmpty(remoteStateInfo.getFullLocationSpecGroupName()))
                && Objects.equals(
                        nullToEmpty(this.optimizerStateInfo.getLinearLocationSpecGroupName()),
                        nullToEmpty(remoteStateInfo.getLinearLocationSpecGroupName()));
    }
