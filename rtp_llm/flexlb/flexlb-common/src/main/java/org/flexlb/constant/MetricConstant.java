...
public class MetricConstant {
     ...
     * Boss线程挂起 QPS
     */
    public static final String BOSS_THREAD_SUSPEND_QPS = "app.boss.thread.suspend.qps";

    /**
     * Boss线程唤醒 QPS
     */
    public static final String BOSS_THREAD_WAKEUP_QPS = "app.boss.thread.wakeup.qps";
     ...
     * 资源可用状态 (1=可用, 0=不可用)
     */
    public static final String RESOURCE_AVAILABLE_STATUS = "app.resource.available.status";
}
