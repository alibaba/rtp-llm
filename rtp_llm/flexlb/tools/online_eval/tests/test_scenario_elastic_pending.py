...
from flexlb_ft.scenario.actions import elastic_pending as pending
...
class PendingTests(unittest.TestCase):
    def run_program(
        ...
        self.assertEqual(
            plan["legacy_case_ids"],
            ["elastic_remove_pending_drain"] if variant == "legacy_terminal" else [],
        )
    ...
    def test_legacy_allows_visible_errors_and_preserves_actual_consumers(self):
