...
from flexlb_ft.scenario.actions import elastic_transient as tr
...
class TransientTests(unittest.TestCase):
    ...
    def test_actual_master_sampler_retains_errors_and_exits(self):
        from flexlb_ft.scenario.contracts import StageOutput
    ...
    def test_birth_spec_preserves_legacy_performance_topology_and_config(self):
        from flexlb_cfg import render_env
        from flexlb_ft.cases.elastic import _transient_spec
        ...
        old = _transient_spec(NS(profile="batch-window"))
    ...
    def run_program(self, bad_survivor=False):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch.object(e, "ElasticMetrics", Metrics), patch.object(
                ...
                "flexlb_ft.harness.http_post_json", master
            ):
