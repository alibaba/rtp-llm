...
from flexlb_ft.support.priority import _d1_spec
...
class DecodePrograms(unittest.TestCase):
    ...
    def test_both_ev2_waves_drain_eight_consumers_and_two_rejections(self):
        ...
        spec = _d1_spec(NS(profile="single-nonbatch"))
    ...
    def test_missing_decode_capacity_is_error_not_legacy_negative_sentinel(self):
    ...
    def test_decode_running_never_outlives_parent_deadline(self):
        from flexlb_ft.scenario.runtime import Deadline, StageTimeout
