...
from flexlb_ft.scenario.actions import admission, engine_control, engine_fault, kv
from flexlb_ft.scenario.actions import kv_capacity as capacity
    ...
    def run_program(
        ...
        class Batch:
                ...
                records.update(
                    ...
                    stream=dict(
                        status=(
                            ...
                            else "UNKNOWN" if rejected else "OK"
                        ),
            ...
            def wait(self, deadline):
                ...
                if self.records[0]["stream"]["status"] == "UNKNOWN":
