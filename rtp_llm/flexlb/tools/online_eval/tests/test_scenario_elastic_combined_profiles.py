...
from flexlb_ft.scenario.actions import elastic_combined as combined
...
class ProfileTests(unittest.TestCase):
    ...
    def test_literal_recovery_retains_typed_error_without_reclassifying_legacy_success(
        self,
    ):
