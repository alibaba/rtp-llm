...
from flexlb_ft.support.priority import _nf_spec
...
class NotFoundPrograms(unittest.TestCase):
    def run_program(self, **kwargs):
        ...
        with tempfile.TemporaryDirectory() as tmp, patch.object(
            ...
            "flexlb_ft.scenario.actions.status_protocol._http", backend.control
        ):
    ...
    def test_exact_nf_config_shapes_and_independent_outcome_planes(self):
        ...
        old = _nf_spec(NS(profile="single-nonbatch"))
