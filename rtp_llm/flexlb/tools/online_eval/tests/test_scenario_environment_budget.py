...
from flexlb_ft.resource_plan import JavaMockBudget, ResourcePlanError, plan_lane_leases
from flexlb_ft.scenario import compile_scenarios
from flexlb_ft.scenario.backend import BoundedOps, JavaMockBackend, make_env_spec
...
class EnvironmentBudgetTest(unittest.TestCase):
    ...
    def test_backend_rejects_unplanned_or_unleased_topology_before_process_setup(self):
        ...
        with tempfile.TemporaryDirectory() as tmp, patch(
            "flexlb_ft.harness.EnvManager.ensure"
        ) as ensure:
