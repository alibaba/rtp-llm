...
from flexlb_ft.scenario.actions.observation import (
    CaptureDeadline,
    DebugUnavailable,
    Observer,
    Sources,
...
class ObservationTest(unittest.TestCase):
    ...
    def test_partial_master_never_complete(self):
        ...
        with patch("flexlb_ft.scenario.actions.observation.DebugClient") as client:
    ...
    def test_epoch_change_performs_no_new_environment_io(self):
        ...
        with patch("flexlb_ft.scenario.actions.observation._read_json") as read:
