...
def flow_start(ctx, params, deadline):
    from scenario.actions.elastic import BoundedFlow
...
def observe_start(ctx, params, deadline):
    from scenario.actions.elastic import ElasticMetrics
...
def remove_validate(params, plan):
    from scenario.actions.elastic import _remove_validate

    return _remove_validate(params, plan)


def remove(ctx, params, deadline):
    from scenario.actions.elastic import _mutation
