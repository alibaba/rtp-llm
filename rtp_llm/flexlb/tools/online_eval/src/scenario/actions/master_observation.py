...
from scenario.actions.engine_control import _http
from scenario.actions.kv import _artifact
from scenario.actions.master import _endpoint_loads, _master_json, _params, _process
...
def _idle_validate(params, plan):
    from scenario.actions.master import _owner_gate_validate
