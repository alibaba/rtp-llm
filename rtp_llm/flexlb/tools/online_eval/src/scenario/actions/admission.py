...
from scenario.actions.master import _master_json
...
def _observe_validate(params, plan):
    ...
    from scenario.actions.engine_control import ENGINE_NAME
...
def _engine_probe(ctx, params, deadline):
    from scenario.actions.elastic import ClientRecords
...
def execution_capacity(events, ids):
    from scenario.actions.execution_evidence import execution_batches
...
def _execution_capacity(ctx, params, deadline):
    from scenario.actions.execution_evidence import read_events
