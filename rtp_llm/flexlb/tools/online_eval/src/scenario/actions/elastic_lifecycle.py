...
def timeline(ctx, params, deadline):
    from scenario.actions.elastic import _snapshot
...
def bounded_batch(
    ...
    from scenario.actions.elastic import RecordedRequests, completeness
...
def accepted_timed_validate(params, plan):
    from scenario.actions.elastic import _accepted_validate

    return _accepted_validate(params, plan)


def accepted_timed(ctx, params, deadline):
    from scenario.actions.elastic import _accepted_wait
...
def add_availability(ctx, params, deadline):
    from scenario.actions.elastic import completeness
...
from scenario.actions.elastic_rebalance import HANDLERS as REBALANCE_HANDLERS

HANDLERS += REBALANCE_HANDLERS

from scenario.actions.elastic_combined import HANDLERS as COMBINED_HANDLERS
