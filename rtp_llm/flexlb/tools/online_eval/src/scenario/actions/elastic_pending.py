...
def remove(ctx, params, deadline):
    ...
    from scenario.actions.elastic import _engine_identity, _snapshot
    from scenario.actions.elastic_concurrent import mutation_http
...
def accounting(ctx, params, deadline):
    from scenario.actions.elastic_lifecycle import accounting_window
...
def recovery(ctx, params, deadline):
    from scenario.actions.elastic_lifecycle import bounded_batch
