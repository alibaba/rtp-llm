...
def fill_validate(params, plan):
    ...
    from scenario.actions.elastic_lifecycle import _name
...
def fill(ctx, params, deadline):
    from scenario.actions.elastic import RecordedRequests, _snapshot
...
def steady(ctx, params, deadline):
    from scenario.actions.elastic_balance import optional_stat, points, shares, spread
...
def transient(ctx, params, deadline):
    from scenario.actions.elastic_balance import deltas, points
