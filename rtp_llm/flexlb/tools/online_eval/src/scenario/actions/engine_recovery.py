...
from scenario.actions import cancel, elastic
from scenario.actions import status_protocol as status
...
def validate_observe(params, plan):
    ...
    if "keys" in p:
        from scenario.actions.kv import _keys
...
def validate_apply(params, plan):
    ...
    plan.reference(p["selection"], "snapshot")
    from scenario.actions.engine_control import validate
...
def execute_apply(ctx, params, deadline):
    from scenario.actions.engine_control import execute
...
def execute_arm(ctx, params, deadline):
    from scenario.actions.engine_control import _http
    from scenario.actions.engine_fault import inject as execute_inject
