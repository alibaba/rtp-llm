"""No-process scenario compiler: python -m flexlb_eval.scenario ROOT [--profile P]."""

import argparse
import json
import sys

from flexlb_eval.scenario import ScenarioError, compile_scenarios, load_scenarios
