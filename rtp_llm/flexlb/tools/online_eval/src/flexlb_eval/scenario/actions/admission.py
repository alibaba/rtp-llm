...
def _engine_probe(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import ClientRecords
...
def execution_capacity(events, ids):
    from flexlb_eval.scenario.actions.execution_evidence import execution_batches
...
def _execution_capacity(ctx, params, deadline):
    from flexlb_eval.scenario.actions.execution_evidence import read_events
