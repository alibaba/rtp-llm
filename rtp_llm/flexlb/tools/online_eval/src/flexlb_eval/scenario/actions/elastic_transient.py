...
from flexlb_eval.scenario.actions import elastic_balance as balance
...
def observe(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import ElasticMetrics
...
def prepare(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import _snapshot
...
def locality(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import completeness, request_success
