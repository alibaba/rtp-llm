...
def pressure(ctx, p, deadline):
    from flexlb_eval.scenario.actions.engine_fault import inject
...
def clear_pressure(ctx, p, deadline):
    from flexlb_eval.scenario.actions.engine_fault import clear
...
def protection(ctx, p, deadline):
    from flexlb_eval.runtime.grade import GradeReport
