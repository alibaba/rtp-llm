...
def fill_validate(params, plan):
    ...
    from flexlb_eval.scenario.actions.elastic_lifecycle import _name
...
def steady(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic_balance import optional_stat, points, shares, spread
...
def transient(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic_balance import deltas, points
