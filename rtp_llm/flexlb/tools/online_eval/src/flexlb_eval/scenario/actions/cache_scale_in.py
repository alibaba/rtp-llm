...
from flexlb_eval.scenario.actions.elastic import _validate, _http
from flexlb_eval.workload.cache_gate import align_send_counters, analyze, window, write_report
...
def observe(ctx, p, deadline):
    ...
    from flexlb_eval.traffic.traffic_source import sha256_file
    from flexlb_eval.runtime.harness import API_JAR, MOCK_JAR
    from flexlb_eval.workload import cache_gate
    ...
    def sample():
        deadline.check()
        from flexlb_eval.monitoring.session import engine_sample
