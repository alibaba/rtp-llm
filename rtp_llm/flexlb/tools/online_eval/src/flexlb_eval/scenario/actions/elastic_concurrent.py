...
def crossfire(ctx, params, deadline):
    ...
    from flexlb_eval.scenario.actions.elastic_lifecycle import _master_get
    ...
    bound_s = None
    if convergence:
        from flexlb_eval.scenario.actions.elastic_convergence import convergence_bound
    ...
    try:
        ...
        if convergence:
            from flexlb_eval.scenario.actions.elastic_convergence import evaluate_convergence
...
def discovery(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import _http
