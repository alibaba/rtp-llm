...
def validate_empty(params, plan):
    from flexlb_eval.scenario.actions.elastic import _validate
...
def wave(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import RecordedRequests, _snapshot
...
def collect(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic import completeness
...
def remove(ctx, params, deadline):
    ...
    from flexlb_eval.scenario.actions.elastic import _engine_identity, _snapshot
    from flexlb_eval.scenario.actions.elastic_concurrent import mutation_http
...
def accounting(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic_lifecycle import accounting_window
...
def recovery(ctx, params, deadline):
    from flexlb_eval.scenario.actions.elastic_lifecycle import bounded_batch
