...
def metric(report, selection, lower, upper):
    if "requests" in selection:
        from flexlb_eval.workload.window_statistics import measure
...
def main(argv=None):
    ...
    for path in args.reports:
        raw = path.read_bytes()
        from flexlb_eval.reporting import load_analysis
    ...
    from flexlb_eval.reporting import write_bundle, run_meta
    from flexlb_eval.workload.view_render import build_spec
