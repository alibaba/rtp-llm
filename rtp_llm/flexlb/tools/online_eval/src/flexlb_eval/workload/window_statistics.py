...
from flexlb_eval.reporting.statistics import percentile_nr
...
def measure(report, selection, lower, upper):
    ...
    return dict(
        ...
        semantics="half-open window; explicit send/completion cohort; pooled nearest-rank percentile (flexlb_eval.reporting.statistics.percentile_nr)",
    )
