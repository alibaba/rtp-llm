...
from flexlb_eval.reporting import render, write_bundle, details, table
from flexlb_eval.reporting.components import chart_spec, panel_spec, kpi_spec
...
def main():
    ...
    if json.loads(aggregate_path.read_text()).get("monitor_backend") == "prometheus":
        from flexlb_eval.monitoring.session import write_monitor_report
