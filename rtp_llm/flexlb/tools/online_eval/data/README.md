...
| `traffic_models/master_batch_templates.json` | 从该模型前 128 个事件派生的 Java Master 回归样本，不含原始请求或 token；源 SHA 在测试时校验。运行 `python3 scripts/pipeline/derive_master_templates.py` 可重建。 |
