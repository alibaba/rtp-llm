...
# 通过 mock engine cluster 的 HTTP API 停止/恢复单个引擎，
...
#   - Load client 全程持续运行（ENABLE_FALLBACK 直连 fallback），不暂停
...
# ===========================================================================
# Step 1: Start Java mock engine cluster
# ===========================================================================
...
echo ""
echo "=== Copy load client final outputs ==="
