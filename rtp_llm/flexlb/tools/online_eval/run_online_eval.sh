...
# unless the caller exports it explicitly (still forwarded via OVERRIDE_ENV_KEYS).
...
OVERRIDE_ENV_KEYS=(
  ...
  FLEXLB_ADMISSION_SLO_ENABLED
  FLEXLB_ADMISSION_SLO_MARGIN_MS
  ...
  FLEXLB_MONITOR_MODE
  FLEXLB_STATUS_LONG_POLL_ENABLED
  FLEXLB_STATUS_LONG_POLL_TIMEOUT_MS
  GRADIENT
  GRADIENT_MAX_SPEED
