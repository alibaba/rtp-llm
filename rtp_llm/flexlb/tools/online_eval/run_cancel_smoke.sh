...
DEFAULT_FLEXLB_CONFIG='{"schemaVersion":2,"scheduler":{"type":"QUEUE","ordering":{"type":"PRIORITY","defaultPriority":50,"preemption":{"allowedVictimStages":["DECODE_RESERVED","DECODE_ENGINE_OWNED"],"engineCancellation":{"ackTimeoutMs":50,"completionTimeoutMs":1000}}},"decision":{"type":"FIXED_WINDOW","maxRequests":32,"maxCollectionWaitMs":10,"maxPredictedExecutionMs":550},"capacity":{"maxOutstandingRequestsGlobal":5000}},"dispatcher":{"type":"BATCH","maxInflightBatchesPerPrefillWorker":4,"enqueueRpcTimeoutMs":5000},"router":{"availabilityHysteresisPercent":30,"roles":{"prefill":{"availability":{"maxPendingRequests":100000},"executionTimeEstimator":{"type":"FORMULA"},"candidateChoice":{"type":"RANDOM_WITHIN_TOLERANCE"}},"decode":{"availability":{"maxKvUsagePercent":90,"maxEngineRequests":1},"kvReservation":{"maxOutputTokensForEstimate":1000}}}}}'
