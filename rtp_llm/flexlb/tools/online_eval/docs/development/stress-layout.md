...
- `src/flexlb_eval/analysis/`：压测证据合并、聚合与 real/mock 对照。
- `src/flexlb_eval/reporting/`：报告 spec、HTML 渲染与内嵌资产。
- `src/flexlb_eval/monitoring/`、`traffic/`、`artifacts/`：各类测试共用的监控、流量和归档组件。
