...
实例名为 `elastic_lifecycle::decode_scale_out_protection::<profile>`，覆盖四种 profile。流程在 `case_programs/elastic_lifecycle.py`，参数在 `config/scenarios/elastic_lifecycle.yaml`，沿用已有弹性程序，没有新增单 case Python 程序。
