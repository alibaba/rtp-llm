...
# Run in a subshell: run_java_load_client uses exec so the background
# pid is the JVM itself; without the subshell the exec would replace
# this script and the EXIT cleanup trap would never run.
( run_java_load_client \
