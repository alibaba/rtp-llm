...
class CaseDef:
    ...
    # Non-empty -> the runner reports the case as SKIP without executing it
    # (stack-version gates: a contract the current stack does not implement,
    # e.g. a v2-only park path on the dsv4 v1 stack).
