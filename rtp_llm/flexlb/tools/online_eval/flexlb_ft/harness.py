...
class EnvManager:
    ...
    def _master_env(self, env: FlexEnv, mspec: Optional[MasterSpec] = None) -> dict:
        ...
        *mspec* is None for a single master. A MasterSpec layers the
        per-instance keys on top of the shared base: DEPLOYMENT_NAME
        (default = the shared label deployment, the mutual-backup pairing),
        FLEXLB_ADVERTISED_IP (Tier-2/3),
