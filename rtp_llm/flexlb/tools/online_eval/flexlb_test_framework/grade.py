...
GRADE_BANDS: Dict[str, dict] = {
    ...
    # balance action implementations consume these bands).
    ...
    # priority scheduling contract — priority action implementations
    # consume these bands).  Three measured bands + fifteen hard
