...
public class PrefillEndpoint extends WorkerEndpoint {
    ...
    public static final class StatusReduction
        ...
        private final PrefillEndpoint source;
        private final StatusSemantics semantics;
        private PrefillWorkLedger.StatusReconciliation reconciliation;
        ...
        private void bind(
                PrefillWorkLedger.StatusReconciliation exactReconciliation) {
            reconciliation = exactReconciliation;
        }

        public PrefillEndpoint source() {
            return source;
        }

        public StatusSemantics semantics() {
            return semantics;
        }

        public List<PrefillWorkLedger.WorkerStatusFact> facts() {
            return reconciliation.schedulerFacts();
        }

        public Throwable publicationFailure() {
            return reconciliation.publicationFailure();
        }
    }
    ...
    protected void closeEndpoint() {
        ...
        try {
            ...
            retirementEvent.bindOwnedItems(
                    retirement.ownedItems());
    ...
    public EndpointStatusReduction applyPreparedStatus(
        ...
        StatusReduction reduction = new StatusReduction(
                this, statusSemantics(observation.role()));
