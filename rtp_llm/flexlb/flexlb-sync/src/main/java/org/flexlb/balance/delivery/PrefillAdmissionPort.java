...
public interface PrefillAdmissionPort {
    ...
    /** Prepare admission for the exact head member. */
    CapacityBoundary.Attempt<PreparedAdmission> prepare(
            DeliveryItem head,
            long predictedMs);
    ...
    interface PreparedAdmission extends AutoCloseable {
        ...
        CapacityBoundary.Attempt<DeliveryItem> append(
         ...
         */
        CommittedAdmission commitUnderLock(
