...
public final class QueueRouteAdmission implements AutoCloseable {
    ...
    public sealed interface PublishResult {
        ...
        record Blocked(
                ...
                PlacementBlockScope scope) implements PublishResult {
            public Blocked {
    ...
    public PublishResult tryPublish(
        ...
        RequestLifecycleCoordinator.RouteCommitResult committed = commitPublication(
                exact,
                lifecycle,
                item,
                false,
    ...
    private RequestLifecycleCoordinator.RouteCommitResult commitPublication(
        ...
        RequestLifecycleCoordinator.RouteCommitResult committed =
