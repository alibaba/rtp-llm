...
public interface PrefillWorkLedger {
    ...
    /** One-shot rollback capability for one provisional DIRECT owner. */
    ...
    /** Exact active identities from a full, same-version WorkerStatus snapshot. */
    List<WorkerStatusFact> heartbeatFacts(
            WorkerStatus.StatusObservation observation);
