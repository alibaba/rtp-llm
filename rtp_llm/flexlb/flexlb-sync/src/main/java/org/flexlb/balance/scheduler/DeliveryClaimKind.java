 ...
 *
 * <p>This is deliberately separate from {@link DeliveryMode}: delivery mode
 * is selected when a request enters the scheduler, while this value records
 * whether the corresponding external delivery has actually started.</p>
 */
