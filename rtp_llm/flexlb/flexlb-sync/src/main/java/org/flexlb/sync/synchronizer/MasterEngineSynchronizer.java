...
public class MasterEngineSynchronizer extends AbstractEngineStatusSynchronizer {
    ...
    public MasterEngineSynchronizer(WorkerAddressService workerAddressService,
        ...
        // 5s default for gRPC calls, must not fallback to sync interval (20ms) which is too short
        this.syncRequestTimeoutMs = EnvUtils.readPositiveLong("SYNC_REQUEST_TIMEOUT_MS", 5000L);
