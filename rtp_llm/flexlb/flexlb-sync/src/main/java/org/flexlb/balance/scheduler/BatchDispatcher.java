 ...
 *   <li>On a proven batch-level failure, the dispatcher releases the
 *       PrefillEndpoint batch before calling {@link DispatchCallback#onFailure}.</li>
 *   <li>An EnqueueBatch deadline is ambiguous and is reported through
 *       {@link DispatchCallback#onDispatchUncertain}; its ledger is retained.</li>
