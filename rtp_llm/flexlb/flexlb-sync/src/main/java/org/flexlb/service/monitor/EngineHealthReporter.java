...
public class EngineHealthReporter {
    ...
    public void reportForwardToMasterResult(String master, String code) {
        monitor.report(FORWARD_TO_MASTER_RESULT, FlexMetricTags.of("master", master, "code", code), 1.0);
    }
}
