 ...
 * only advances it through {@link #deliver(DeliveryMetadata)} or settles an
 * unconsumed callback through {@link #fail(Throwable)}; it never inspects the
 * strategy's endpoint, capacity, or transport resources.</p>
 */
