...
public class DefaultRouter implements Router {
    ...
    private MasterResponse validateRequest(BalanceContext balanceContext) {
        if (balanceContext.getMasterRequest() == null) {
            ...
            return createErrorResponse(StrategyErrorType.INVALID_REQUEST);
        }
        ...
        if (MapUtils.isEmpty(workerStatusMap)) {
            ...
            return createErrorResponse(StrategyErrorType.NO_AVAILABLE_WORKER);
        }
    ...
    private MasterResponse buildSuccessResponse(Long interRequestId, List<ServerStatus> serverStatusList) {
    ...
    private MasterResponse buildFailureResponse(Long interRequestId, RoutingResult routingResult) {
     ...
     * @return 错误响应
     */
    private MasterResponse createErrorResponse(StrategyErrorType errorType) {
        return MasterResponse.code(errorType.getErrorCode());
    }
}
