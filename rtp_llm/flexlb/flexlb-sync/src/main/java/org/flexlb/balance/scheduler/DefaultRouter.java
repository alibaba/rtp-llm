...
public class DefaultRouter implements Router {
    ...
    private PinnedRouting selectAll(
        ...
        try {
            for (RoleType role : roles) {
                ...
                if (result instanceof EndpointSelection.Missed missed) {
                    Logger.debug(
                ...
                SelectedRole selection =
                        ((EndpointSelection.Selected) result).endpoint();
                try {
    ...
    private EndpointSelection directSelection(
        ...
        return selected == null
                ? EndpointSelection.unavailablePool(role)
