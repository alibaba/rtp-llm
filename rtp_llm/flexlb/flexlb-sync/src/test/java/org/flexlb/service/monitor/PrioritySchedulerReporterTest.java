...
/**
 * Cancel metric contract of {@link PrioritySchedulerReporter}: the cancel
...
class PrioritySchedulerReporterTest {

    @Mock
    private FlexMonitor monitor;

    private PrioritySchedulerReporter reporter;

    @BeforeEach
    void setUp() {
        reporter = new PrioritySchedulerReporter(monitor);
    }
