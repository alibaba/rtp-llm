...
class CostBasedPrefillSelectionMetricTest {
    ...
    private static Fixture fixture(
        ...
        config.setDispatcher(batchDelivery
                ? new BatchDispatcherConfig()
                : new NonBatchDispatcherConfig());
        ...
        ResourceMeasureFactory measureFactory = mock(ResourceMeasureFactory.class);
        when(measureFactory.getMeasure(any())).thenReturn(measure);
