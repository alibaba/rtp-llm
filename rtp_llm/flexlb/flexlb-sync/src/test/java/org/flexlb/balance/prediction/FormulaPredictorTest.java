...
class FormulaPredictorTest {
    ...
    @Test
    void generatedDsv4FitterExpressionParsesAndSumsPerItemFeatures() {
        // Mirrors formula_text([1, 1, 1, 1, 1, 1]) in
        // deepseek_v4_prefill_formula_fit.py. Keep this production-parser guard
        // aligned with the fitter's exported expression grammar.
        ...
        // Per-item feature sums are 4.25 and 11.0; batch prediction preserves precision.
