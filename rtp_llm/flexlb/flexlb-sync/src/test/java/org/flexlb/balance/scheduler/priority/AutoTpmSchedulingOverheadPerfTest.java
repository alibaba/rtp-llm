...
class AutoTpmSchedulingOverheadPerfTest {
    ...
    private static final class PerfHarness implements AutoCloseable {
        ...
        PerfHarness(Consumer<FlexlbConfig> customize) {
            ...
            // Mock gRPC: immediate success, count dispatches
            ...
            decodeWs.setIp(DECODE_IP);
            decodeWs.setPort(DECODE_HTTP);
            decodeWs.setGrpcPort(DECODE_GRPC);
            decodeWs.setAvailableKvCacheTokens(new AtomicLong(1_000_000_000L));
            decodeWs.setTotalKvCacheTokens(new AtomicLong(2_000_000_000L));
