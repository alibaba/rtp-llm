...
| [02-queue-scheduling](02-queue-scheduling.md) | QueueManager / RequestScheduler / RouteService、请求生命周期、重试与取消 |
| [03-resource-management](03-resource-management.md) | DynamicWorkerManager 动态许可、水位公式、ReducibleSemaphore 门控 |
...
```
balance/
├── scheduler/      Router / DefaultRouter / QueueManager / RequestScheduler
├── strategy/       LoadBalancer + 4 策略实现 + LoadBalanceStrategyFactory
└── resource/       DynamicWorkerManager / ResourceMeasure×2 / ResourceMeasureFactory / ReducibleSemaphore
...
```
POST /rtp_llm/schedule (HttpLoadBalanceServer, 端口 7001)
