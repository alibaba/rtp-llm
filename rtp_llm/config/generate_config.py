...
class GenerateConfig(BaseModel):
    ...
    def _validate_prefill_only(self) -> None:
        # Keep this before the prefill-only early return, matching C++
        # validatePrefillOnly(): prompt scoring constraints apply regardless of
        # the original max_new_tokens value.
