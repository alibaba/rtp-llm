...
def build_model_config(
    ...
    hidden_state_capture_fail_open = getattr(
        model_args, "hidden_state_capture_fail_open", None
    )
    if hidden_state_capture_fail_open is not None:
        model_config.hidden_state_capture_fail_open = hidden_state_capture_fail_open
