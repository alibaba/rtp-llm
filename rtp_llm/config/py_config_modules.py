...
class MMKvcmConfig:
    def __init__(self):
        ...
        # from the existing RECO_* KVCM settings (RECO_CLIENT_CONFIG takes
        # precedence when present). They intentionally have no independent
        # MM_KVCM_* connection or identity environment variables.
