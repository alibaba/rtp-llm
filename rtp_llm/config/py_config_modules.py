...
# Keep these values aligned with transport/rdma/MMRdmaTransport.h.
...
class MMRdmaConfig:
    def __init__(self):
        ...
        self.max_inflight_bytes: int = 8 * 1024 * 1024 * 1024
...
class VitConfig:
    ...
    def to_string(self):
        ...
        return (
            ...
            f"mm_rdma_max_inflight_bytes: {rdma.max_inflight_bytes}\n"
