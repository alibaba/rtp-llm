...
from rtp_llm.utils.gemm_utils.device_map import get_device, get_lut_info
        ...
        for config_file in lut_info.get_files():
            with open(config_file) as reader:
                ...
                for s in contents:
                    ...
                    if quant_info == "int8":
                        torch.ops.rtp_llm.insert_fp16_int8_gemm_config(
                            int(configs[0]),
                            int(configs[1]),
                            int(configs[2]),
                            configs[3],
                        ...
                        torch.ops.rtp_llm.insert_fp16_int4_gemm_config(
                            int(configs[0]),
                            int(configs[1]),
                            int(configs[2]),
                            configs[3],
                        ...
                        torch.ops.rtp_llm.insert_w8a8_gemm_config(
                            int(configs[0]),
                            int(configs[1]),
                            int(configs[2]),
                            configs[3],
