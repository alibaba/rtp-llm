    ...
    def fastsafetensors_weights_iterator(
        ...
        def iterator(device: str, use_tqdm_on_load: bool):
            ...
            if hasattr(fastsafetensors, "AutoLoader"):
                ...
                loader = (
                    PerExpertParallelLoader(stacked_key_config, **loader_kwargs)
                    if stacked_key_config
                    else fastsafetensors.ParallelLoader(**loader_kwargs)
                )
                close = loader.loader.close
            try:
