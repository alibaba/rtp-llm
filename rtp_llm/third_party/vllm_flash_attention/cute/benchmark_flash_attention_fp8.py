...
#
# Run (recommended):
#   python -m rtp_llm.third_party.vllm_flash_attention.cute.benchmark_flash_attention_fp8
#
# Notes:
...
from rtp_llm.third_party.vllm_flash_attention.cute.benchmark import benchmark_forward
from rtp_llm.third_party.vllm_flash_attention.cute.interface import _flash_attn_fwd as flash_attn_cute_fwd
