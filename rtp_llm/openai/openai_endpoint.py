...
def prepare_model_config_for_openai(
    ...
    """Set on model_config the fields required by OpenaiEndpoint. Call before creating OpenaiEndpoint."""
    ...
    model_config.template_type = template_type
