    ...
    def detect_and_parse(self, text: str, tools: List[Tool]) -> StreamingParseResult:
        ...
        if self.encoding_module and hasattr(self.encoding_module, "parse_message_from_completion_text"):
            try:
                ...
                logger.info(f"[DeepSeekV32Detector] Official parser succeeded: reasoning={len(reasoning_content)} chars, content={len(content)} chars, tool_calls={len(tool_calls_list)}")
                ...
                # Convert tool_calls to ToolCallItem format
                calls = []
                for tc in tool_calls_list:
                    ...
                    tool_item = {
                        ...
                        "parameters": function.get("arguments")  # Already a JSON string
                    }
