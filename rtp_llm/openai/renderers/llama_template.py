#
# Acknowledgement:
#   This code is adapted from LLaMA-Factory:
#   https://github.com/hiyouga/LLaMA-Factory/blob/1653c2243895cca69c6efecc158881ed6e7c4129/src/llmtuner/data/template.py
    ...
    def _encode(
        ...
        for turn_idx, (query, resp) in enumerate(history):
            ...
            query_ids = self._convert_inputs_to_ids(
                tokenizer, context=self.prompt, query=query, idx=str(turn_idx + 1)
            )
...
register_template(
    name="internlm2",
    prefix=["<s>[UNUSED_TOKEN_146]system\n{{system}}[UNUSED_TOKEN_145]\n"],
    prompt=[
