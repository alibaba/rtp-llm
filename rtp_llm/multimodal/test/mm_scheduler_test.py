...
class MMSchedulerTest(TestCase):
    ...
    def test_memory_reserve_rejects_indivisible_item_before_forward(
        ...
        self.assertIsInstance(ctx.exception.__cause__, GPUMemoryHeadroomError)
    ...
    def test_memory_reserve_server_arg_and_scheduler_config(self):
        """The public CLI/env-backed arg reaches GPU-batch scheduler kwargs."""
        config = VitConfig()
