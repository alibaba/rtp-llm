...
class MMProfilerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.profiler._output_path = self.tmp_dir
    ...
    def test_start_profile_returns_started(self):
        result = self.profiler.start_profile(count=5)
    ...
    def test_output_dir_created_on_init(self):
        self.assertTrue(os.path.isdir(self.profiler._output_path))

    def test_start_profile_rejects_double_start(self):
        self.profiler.start_profile(count=5)
        result = self.profiler.start_profile(count=3)
    ...
    def test_end_profile_while_armed(self):
        self.profiler.start_profile(count=10)
        result = self.profiler.end_profile()
    ...
    def test_get_status_after_profile(self):
        self.profiler.start_profile(count=2)
        self._run_profiled_request()
    ...
    def test_full_lifecycle(self):
        result = self.profiler.start_profile(count=2)
        self.assertEqual(result["status"], "started")
    ...
    def test_concurrent_start_only_one_wins(self):
        ...
        def try_start():
            barrier.wait()
            r = self.profiler.start_profile(count=5)
            results.append(r)
