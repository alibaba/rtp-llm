...
class DisabledMMRdmaOutputExporter(EmptyClass):
    """Stand-in for MMRdmaOutputExporter when libth_transformer is unavailable.
...
def _set_engine_fallbacks() -> None:
    ...
    globals()["MMRdmaOutputExporter"] = DisabledMMRdmaOutputExporter
...
def _load_engine_ops(required: bool = False) -> None:
    ...
    with _engine_ops_lock:
        ...
        try:
            ...
            from libth_transformer import MMRdmaOutputExporter, RtpEmbeddingOp, RtpLLMOp

            globals()["EmbeddingCppOutput"] = EmbeddingCppOutput
            globals()["MMRdmaOutputExporter"] = MMRdmaOutputExporter
