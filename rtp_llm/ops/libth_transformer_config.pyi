...
# REBASE CONFLICT CONTEXT(e2e00e570): source branch's generated stub lacked
# `GrammarConfig`; new base already exposes it. Keep the new base symbol list.
...
class KVCacheConfig:
    ...
    linear_request_cache_avg_query_length: int
    linear_step: int
