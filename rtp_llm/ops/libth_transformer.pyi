...
class RtpLLMOp:
    def __init__(self) -> None:
        ...
    def init(self, model: typing.Any, engine_config: typing.Any, vit_config: typing.Any, mm_process_engine: typing.Any, propose_model: typing.Any, token_processor: typing.Any, compiled_grammars: typing.Any) -> None:
        ...
