...
class NumericalStatusScope:
    ...
    NONE: typing.ClassVar[NumericalStatusScope]
    BATCH: typing.ClassVar[NumericalStatusScope]
    ORIGIN_ROW: typing.ClassVar[NumericalStatusScope]
    __members__: typing.ClassVar[dict[str, NumericalStatusScope]]
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class NumericalStatusView:
    ...
    @property
    def scope(self) -> NumericalStatusScope: ...
    @property
    def epoch(self) -> int: ...
...
class PyModelInputs:
    ...
    @property
    def numerical_status(self) -> NumericalStatusView: ...
