...
from libth_transformer_config import CacheGroupType
import torch
import typing
from . import rtp_llm_ops
__all__: list[str] = ['BertEmbeddingInputs', 'CacheGroupType', 'CacheStoreWriter', 'KVCache', 'LayerKVCache', 'ParamsBase', 'PyAttentionInputs', 'PyCacheStoreInputs', 'PyContextParallelParams', 'PyEmbeddingInputs', 'PyModelInitResources', 'PyModelInputs', 'PyModelOutputs', 'PyMultimodalInputs', 'PyPrefillCudaGaphCopyParams', 'TypeMeta', 'clear_comm_ops', 'destroy_cpu_tp_broadcaster', 'get_device_id', 'get_scalar_type', 'get_typemeta', 'init_cpu_tp_broadcaster', 'init_exec_ctx', 'preprocess_gemm_weight_by_key', 'preprocess_weight_scale', 'register_comm_ops', 'rtp_llm_ops']
...
class CacheStoreWriter:
    def write(self, arg0: PyCacheStoreInputs, arg1: LayerKVCache) -> None:
        ...
class KVCache:
    ...
    def group_tags(self) -> list[str]:
        """
        Cache group tags in topology group id order
        """
    @property
    def layer_count(self) -> int:
        """
        Number of model-local cache layers
        """
class LayerKVCache:
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, kv_cache_base: torch.Tensor, seq_size_per_block: int, layer_id: int = -1, group_id: int = -1, tag: str = 'default', kv_scale_base: typing.Any = None) -> None:
        ...
    @property
...
class PyAttentionInputs:
    ...
    def cache_store_inputs(self) -> PyCacheStoreInputs | None:
        ...
    @property
    def cache_store_writer(self) -> CacheStoreWriter:
        ...
    @property
...
class PyModelInputs:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, input_ids: torch.Tensor = ..., input_hiddens: torch.Tensor = ..., combo_position_ids: torch.Tensor = ..., embedding_inputs: PyEmbeddingInputs = ..., multimodal_inputs: PyMultimodalInputs = ..., attention_inputs: typing.Any = ..., bert_embedding_inputs: BertEmbeddingInputs = ...) -> None:
        ...
    @property
    def attention_inputs(self) -> typing.Any:
        """
        A PyAttentionInputs value or a tag-to-PyAttentionInputs mapping
        """
    @attention_inputs.setter
    def attention_inputs(self, arg1: typing.Any) -> None:
        ...
    @property
...
def init_cpu_tp_broadcaster(tp_rank: int, tp_size: int, base_path: str) -> None:
    ...
def init_exec_ctx(device_id: int, trace_memory: bool, enable_comm_overlap: bool, mla_ops_type: int) -> None:
    ...
