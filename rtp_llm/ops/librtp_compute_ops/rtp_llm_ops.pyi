...
def fill_mla_params(t_prefill_lengths: torch.Tensor, t_sequence_lengths: torch.Tensor, t_input_lengths: torch.Tensor, t_kv_cache_block_id_host: torch.Tensor, seq_size_per_block: int) -> FlashInferMlaAttnParams:
    ...
def _flashmla_merge_attention_states_segmented_in_place(output: torch.Tensor, output_lse: torch.Tensor, partial_output: torch.Tensor, partial_lse: torch.Tensor, partial_q_indptr: torch.Tensor, destination_starts: torch.Tensor) -> None:
    """
