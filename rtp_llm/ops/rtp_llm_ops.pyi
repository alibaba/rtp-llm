...
class AiterAttnPyParams:
    def __init__(self, input_lengths: torch.Tensor, is_prefill: bool) -> None: ...
    def __init__(
        self,
    ...
    def kv_cache_block_id_host(self) -> torch.Tensor: ...
    def kv_cache_block_id_device(self) -> torch.Tensor: ...

class AiterParamsCreator:
    def __init__(self) -> None: ...
    def create_prefill_params(self, params: AiterAttnPyParams) -> Any: ...
    def create_decode_params(self, params: AiterAttnPyParams) -> Any: ...
