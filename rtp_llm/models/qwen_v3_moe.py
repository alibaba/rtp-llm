...
class QWenV3MoeWeight(QWenV2MoeWeight):
    def __init__(self, model_config, engine_config, merge_lora=False, tp_size=1, tp_rank=0, vit_config=None, prefix="", **kwargs: Any):
        super().__init__(model_config, engine_config, merge_lora, tp_size, tp_rank, vit_config, prefix=prefix, **kwargs)
        self.bias = False
