...
class Qwen3MoeEagle3Weight(QWenV2Weight):
    def __init__(self, model_config=None, parallelism_config=None, hw_kernel_config=None, kv_cache_config=None, **kwargs):
        # Support both old and new calling conventions
        if model_config is None and 'config' in kwargs:
            # Old calling convention: config, engine_config
            ...
            # New calling convention: model_config, parallelism_config, hw_kernel_config, kv_cache_config, ...
            super().__init__(model_config=model_config, parallelism_config=parallelism_config, hw_kernel_config=hw_kernel_config, kv_cache_config=kv_cache_config, **kwargs)
        self.bias = False
