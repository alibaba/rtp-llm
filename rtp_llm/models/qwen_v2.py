...
class QWenV2(QWen):
    ...
    def _from_config_json(config: "ModelConfig", config_json: Dict[str, Any]):
        ...
        # transformers>=5.2 moved rope_theta under rope_parameters. Prefer
        # the legacy top-level value when both are present, but do not silently
        # fall back to base=10000 for new-format checkpoints.
