...
class MMProcessEngineTest(TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.mm_process_engine = MMProcessEngine(self.model, PyEnvConfigs())
    ...
    def test_preprocess(self):
        ...
        mm_process_engine = MMProcessEngine(model, PyEnvConfigs())
        try:
    ...
    def test_broken_process_pool_recovery(self):
        ...
        mm_process_engine_crash = MMProcessEngine(model_crash, PyEnvConfigs())
        ...
        mm_process_engine_normal = MMProcessEngine(model_normal, PyEnvConfigs())
