...
def combo_to_batch(
    hidde_states: torch.Tensor, input_ids: torch.Tensor, input_lengths: torch.Tensor
    ...
    for input_length in input_lengths:
        ...
        sliced_input_ids.append(
            torch.IntTensor(input_ids[hidden_bias : hidden_bias + input_length])
        )
