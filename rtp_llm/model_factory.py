...
class ModelFactory:
    ...
    def create_model_configs(
        ...
        model_config.generate_env_config = generate_env_config if generate_env_config is not None else GenerateEnvConfig()
        model_config.render_config = render_config if render_config is not None else RenderConfig()
        ...
        if sp_type and sp_type != SpeculativeType.NONE:
            ...
            if propose_ckpt_path:
                ...
                # Set renderer configuration fields for propose model (same as main model)
                propose_model_config.generate_env_config = model_config.generate_env_config
                propose_model_config.render_config = model_config.render_config
