...
class SliceStopWordListTest(TestCase):
    def __init__(self, *args, **kwargs):
        ...
        ckpt_path = os.path.join(os.getcwd(), "rtp_llm/test/model_test/fake_test/testdata/llama/fake/hf_source")
    ...
    @mock.patch("rtp_llm.async_decoder_engine.backend_rpc_server_visitor.BackendRPCServerVisitor.enqueue")
