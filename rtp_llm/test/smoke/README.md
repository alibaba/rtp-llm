...
`//rtp_llm/test/smoke:input_embedding_prefill_cuda_graph_rpc_test` uses the same
numerical checks with generation-prefill CUDA graphs. It asserts real replay,
16/64-token bucket changes, over-limit eager fallback and recovery, and mask
