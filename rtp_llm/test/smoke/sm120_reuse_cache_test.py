"""Compare long Qwen3.5 FP8 requests with and without local prefix reuse."""
...
class SM120ReuseCacheTest(unittest.TestCase):
    def setUp(self):
        ...
        self.assertTrue(
            self.server.start_server(model_path=MODEL_PATH, model_type="qwen35_dense"),
            "Qwen3.5 dense FP8 server failed to start",
        )
