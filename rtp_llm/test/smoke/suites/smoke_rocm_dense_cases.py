"""Auto-generated: smoke cases for suite ``smoke_rocm_dense``.

Derived from monolithic SMOKE_TESTS["smoke_rocm_dense"]. Edit case definitions here;
do NOT add framework helpers (those live in rtp_llm.test.smoke_framework).
"""

SMOKE_CASES = {   'rocm_dense_qwen3_8b_hipgraph_tp2': {   'task_info': 'data/model/qwen3/q_r_new_model_py.json',
                                            ...
                                            'timeout': 600},
    'rocm_dense_qwen3_8b_ptpc': {   'task_info': 'data/model/qwen3/ptpc_q_r_8b.json',
