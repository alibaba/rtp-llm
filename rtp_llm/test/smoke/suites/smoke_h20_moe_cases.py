"""Auto-generated: smoke cases for suite ``smoke_h20_moe``.

Derived from monolithic SMOKE_TESTS["smoke_h20_moe"]. Edit case definitions here;
do NOT add framework helpers (those live in rtp_llm.test.smoke_framework).
"""

SMOKE_CASES = {   'moe_masked_fp8_tp2': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py_masked_without_deepep_tp2.json',
                              ...
                              'timeout': 600},
    'moe_w4a8_int4': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py_w4a8_int4_ptpc.json',
                         ...
                         'markers': ['smoke', 'cuda', 'H20'],
                         'timeout': 600},
    'moe_deepep_continuous_dp2': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py.json',
                                     ...
                                     'markers': ['smoke', 'cuda', 'H20'],
                                     'timeout': 600},
    'moe_deepep_ll_tp2': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py_tp2_ll.json',
                             'smoke_args': '--warm_up 0 --act_type BF16 --reserver_runtime_mem_mb 8192 '
                             ...
                             'markers': ['smoke', 'cuda', 'H20'],
                             'timeout': 600},
    'moe_deepep_normal_tp2': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py_tp2.json',
                                 'smoke_args': '--warm_up 0 --act_type BF16 --reserver_runtime_mem_mb 8192 '
                                 ...
                                 'markers': ['smoke', 'cuda', 'H20'],
                                 'timeout': 600},
    'moe_headwise': {   'task_info': 'data/model/qwen3_moe/q_r_30b_py_headwise.json',
                        'smoke_args': '',
                        'envs': [   'WARM_UP=0',
                                    'LOAD_PYTHON_MODEL=1',
                                    'ACT_TYPE=BF16',
                        ...
                        'markers': ['smoke', 'cuda', 'H20'],
                        'timeout': 600},
    'moe_fp8pt_batched_cudagraph': {   'task_info': 'data/model/qwen3_moe/q_r_fp8_per_tensor_batched_cuda_graph_30b.json',
                                       ...
                                       'markers': ['smoke', 'cuda', 'H20'],
                                       'timeout': 600},
    'moe_fp8pt_load_quant': {   'task_info': 'data/model/qwen3_moe/q_r_fp8_per_tensor_30b_load_quant.json',
                                ...
                                'markers': ['smoke', 'cuda', 'H20'],
                                'timeout': 600},
    'moe_cp_pd': {   'task_info': 'data/model/qwen3_moe/q_r_30b_fp8_py_cp2.json',
                     'smoke_args': {   'prefill': '--act_type BF16 --cache_store_rdma_mode 0 --use_local 1 '
