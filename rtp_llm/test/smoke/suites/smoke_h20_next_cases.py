"""Auto-generated: smoke cases for suite ``smoke_h20_next``.

Derived from monolithic SMOKE_TESTS["smoke_h20_next"]. Edit case definitions here;
...
SMOKE_CASES = {   'next_mtp_basic': {   'task_info': 'data/model/qwen3_next/q_r_next_fp8_tp2_mtp.json',
    ...
    'next_mtp_pd_reuse': {   'task_info': 'data/model/qwen3_next/q_r_next_fp8_tp2_mtp_pd.json',
                             'smoke_args': {   'prefill': '--load_cache_timeout_ms 120000 --seq_size_per_block 2048 '
    ...
    'next_cudagraph_deepep': {   'task_info': 'data/model/qwen3_next/q_r_next_cuda_graph.json',
                                 ...
                                 'markers': ['smoke', 'cuda', 'H20'],
                                 'timeout': 600},
    'next_long_reuse_memcache': {   'task_info': 'data/model/qwen3_next/q_r_next_fp8_tp2_long_input_reuse_cache.json',
                                    ...
                                    'markers': ['smoke', 'cuda', 'H20'],
                                    'timeout': 600},
    'next_long_reuse_remote': {   'task_info': 'data/model/qwen3_next/q_r_next_fp8_tp2_long_input_reuse_remote_cache.json',
    ...
    'next_pd': {   'task_info': 'data/model/qwen3_next/q_r_next_fp8_tp2_pd_sep.json',
                   'smoke_args': {   'prefill': '--load_cache_timeout_ms 120000 --seq_size_per_block 2048 --act_type '
