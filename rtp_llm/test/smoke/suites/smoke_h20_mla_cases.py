"""Auto-generated: smoke cases for suite ``smoke_h20_mla``.

Derived from monolithic SMOKE_TESTS["smoke_h20_mla"]. Edit case definitions here;
do NOT add framework helpers (those live in rtp_llm.test.smoke_framework).
"""

SMOKE_CASES = {   'mla_fp8_redundant_expert_tp2': {   'task_info': 'data/model/deepseek_v2/q_r_3090_mla_r24.json',
                                        ...
                                        'timeout': 600},
    'mla_fp8_reuse_absorb_tp2': {   'task_info': 'data/model/deepseek_v2/q_r_3090_mla.json',
                                    ...
                                    'markers': ['smoke', 'cuda', 'H20'],
                                    'timeout': 600},
    'mla_noquant_dp2': {   'task_info': 'data/model/deepseek_v2/q_r_mla_pymodel.json',
                           ...
                           'markers': ['smoke', 'cuda', 'H20'],
                           'timeout': 600},
    'mla_cudagraph_pad_reuse': {   'task_info': 'data/model/deepseek_v2/q_r_mla_pymodel.json',
                                   ...
                                   'markers': ['smoke', 'cuda', 'H20'],
                                   'timeout': 600},
    'mla_cudagraph_fp8pt_deepep_dp2': {   'task_info': 'data/model/deepseek_v2/q_r_mla_cudagraph_per_tensor.json',
                                          ...
                                          'markers': ['smoke', 'cuda', 'H20'],
                                          'timeout': 600},
    'mla_cudagraph_fp8pb_deepep_dp2': {   'task_info': 'data/model/deepseek_v2/q_r_mla_pymodel_cudagraph.json',
                                          'smoke_args': '--warm_up 0 --seq_size_per_block 64 --act_type BF16 '
                                          ...
                                          'markers': ['smoke', 'cuda', 'H20'],
                                          'timeout': 600},
    'mla_kernel_block_size': {   'task_info': 'data/model/glm5/glm_5_fp8_q_r_h20.json',
                                 ...
                                 'markers': ['smoke', 'cuda', 'H20'],
                                 'timeout': 600},
    'mla_cudagraph_deepep_tp2': {   'task_info': 'data/model/deepseek_v32_4layers/v32_fp8_q_r_h20_cuda_graph.json',
                                    'smoke_args': '--warm_up 0 --seq_size_per_block 64 --act_type BF16 '
                                    ...
                                    'markers': ['smoke', 'cuda', 'H20'],
                                    'timeout': 600},
    'mla_fp8_basic': {   'task_info': 'data/model/deepseek_v32_4layers/v32_fp8_q_r_h20.json',
                         ...
                         'markers': ['smoke', 'cuda', 'H20'],
                         'timeout': 600},
    'mla_not_fast_path_reuse': {   'task_info': 'data/model/deepseek_v32_4layers/v32_fp8_q_r_h20_long.json',
                                   'smoke_args': '--warm_up 0 --seq_size_per_block 64 --act_type BF16 '
                                   ...
                                   'markers': ['smoke', 'cuda', 'H20'],
                                   'timeout': 600},
    'mla_fast_path_reuse': {   'task_info': 'data/model/deepseek_v32_4layers/v32_fp8_q_r_h20_66_seq.json',
                               ...
                               'markers': ['smoke', 'cuda', 'H20'],
                               'timeout': 600},
    'mla_cp_pd': {   'task_info': 'data/model/glm5/glm_5_fp8_q_r_h20_cp.json',
                     'smoke_args': {   'prefill': '--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 '
                     ...
                     'markers': ['smoke', 'cuda', 'H20'],
                     'timeout': 600},
    'mla_load_quant_tp2': {   'task_info': 'data/model/deepseek-r1-4layer/r1_fp8_q_r_h20.json',
