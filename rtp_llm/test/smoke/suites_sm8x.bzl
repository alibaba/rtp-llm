    ...
    native.test_suite(
        ...
        tests = [
            smoke_test(
                ...
                smoke_args="--act_type FP16 --load_python_model 1 --warm_up 0",
                gpu_type=["L20"],
            ),
            smoke_test(
                name="random_seed",
            ...
            smoke_test(
                name="bf16",
                task_info="data/model/qwen25/q_r_s.json",
                smoke_args="--act_type BF16 --load_python_model 1 --warm_up 0",
                gpu_type=["L20"],
            ),
            smoke_test(
                name="tp2",
                task_info="data/model/qwen25/q_r_s_fp16.json",
                smoke_args="--load_python_model 1 --warm_up 0 --act_type FP16 --tp_size 2 --deterministic_attn 1",
                gpu_type=["L20"],
            ),
            smoke_test(
                name="beam_search_tp2",
                task_info="data/model/qwen25/bs_q_r.json",
                smoke_args="--act_type FP16 --tp_size 2 --deterministic_attn 1 --load_python_model 1 --warm_up 0",
                gpu_type=["L20"],
            ),
            smoke_test(
                name="frontend_app",
                ...
                gpu_type=["L20"],
                smoke_args= {
                    "frontend": "--max_seq_len 2048 --role_type FRONTEND --load_python_model 1 --warm_up 0",
                    "pd_fusion": "--reuse_cache 1 --seq_size_per_block 8 --act_type FP16 --load_python_model 1 --warm_up 0"
                }
            ),
            ...
            smoke_test(
                ...
                smoke_args="--seq_size_per_block 64 --load_python_model 1 --embedding_model 1 --act_type BF16 --concurrency_limit 2 --enable_cuda_graph 1  --enable_cuda_graph_debug_mode 1 --prefill_capture_config '150,155,160,380,400' --task_type DENSE_EMBEDDING --reserver_runtime_mem_mb 3072",
