...
def rocm_oss_suites():
    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                name="rocm_beam_search_tp2",
                task_info="data/model/qwen25/bs_q_r_rocm.json",
                smoke_args="--act_type BF16 --tp_size 2 --warm_up 0 --use_aiter_pa 1 --use_asm_pa 0 --disable_flash_infer 1 --seq_size_per_block 16",
                gpu_type=["MI308X-ROCM7"],
            ),
        ],
    )
