    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                smoke_args={
                    "prefill": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type PREFILL --seq_size_per_block 64 --dp_size 1 --tp_size 2 --ep_size 2 --world_size 2 --warm_up 0 --moe_strategy mega_moe  --use_deepep_moe 0 --use_deepep_low_latency 0 --cp_rotate_method ALL_GATHER --use_all_gather=0",
                    "decode": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type DECODE --seq_size_per_block 64 --ep_size 2 --dp_size 2 --world_size 2 --warm_up 0 --moe_strategy mega_moe --cp_rotate_method PREFILL_CP --use_all_gather=0 --enable_cuda_graph 1"
                },
                gpu_type=["L20D"]
            ),
            smoke_test(
                name="mla_fp4_moe_cp_pd",
                task_info="data/model/glm5/glm_5_fp8_q_r_mega_moe_cp.json",
                envs={
                    "prefill": ["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++"],
                    "decode": ["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++"]},
                smoke_args={
                    "prefill": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type PREFILL --seq_size_per_block 64 --dp_size 1 --tp_size 2 --ep_size 2 --world_size 2 --warm_up 0 --quantization MODELOPT_FP4_HYBRID_FP8_PER_BLOCK --use_deepep_moe 1 --use_deepep_low_latency 0 --cp_rotate_method ALL_GATHER --use_all_gather=0",
                    "decode": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type DECODE --seq_size_per_block 64 --ep_size 2 --dp_size 2 --world_size 2 --warm_up 0 --quantization MODELOPT_FP4 --use_deepep_moe 1 --use_deepep_low_latency 1 --cp_rotate_method PREFILL_CP --use_all_gather=0 --enable_cuda_graph 1"
                },
                gpu_type=["L20D"]
            ),
            smoke_test(
            ...
            smoke_test(
                name="mla_mega_moe_basic",
                task_info="data/model/glm5/glm_5_fp8_q_r_mega_moe.json",
                ...
                smoke_args="--warm_up 0 --seq_size_per_block 64 --act_type BF16 --enable_cuda_graph 0 --tp_size 1 --ep_size 4 --world_size 4 --dp_size 4 --moe_strategy mega_moe --reserver_runtime_mem_mb 8192 --force_cpu_load_weights 1",
                gpu_type=["L20D"],
            ),
            smoke_test(
                name="mla_mega_moe_online_fp4_cp_pd",
                task_info="data/model/glm5/glm_5_q_r_mega_moe_online_fp4_cp.json",
                envs={
                    "prefill": ["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++", "MOE_STRATEGY=mega_moe", "USE_ONLINE_FP4GEMM=1"],
                    "decode": ["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++", "MOE_STRATEGY=mega_moe", "USE_ONLINE_FP4GEMM=1"]},
                smoke_args={
                    "prefill": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type PREFILL --seq_size_per_block 64 --dp_size 1 --tp_size 2 --ep_size 2 --world_size 2 --warm_up 0 --moe_strategy mega_moe --use_deepep_moe 0 --use_deepep_low_latency 0 --cp_rotate_method ALL_GATHER --use_all_gather=0",
                    "decode": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type DECODE --seq_size_per_block 64 --ep_size 2 --dp_size 2 --world_size 2 --warm_up 0 --moe_strategy mega_moe --cp_rotate_method PREFILL_CP --use_all_gather=0 --enable_cuda_graph 1"
                },
            ...
            smoke_test(
                name="mla_mtp_baseline",
                envs=["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++", "MOE_STRATEGY=mega_moe"],
                task_info="data/model/glm5/glm_5_fp8_q_r_h20_mtp.json",
                smoke_args="--fp8_kv_cache 0 --act_type BF16 --seq_size_per_block 64 --tp_size 1 --dp_size 4 --ep_size 4 --world_size 4 --warm_up 0 --reserver_runtime_mem_mb 8192 --moe_strategy mega_moe --enable_cuda_graph 0",
                gpu_type=["H20"],
            ),
            smoke_test(
                name="mla_mtp_basic",
                envs=["CUDA_HOME=/usr/local/cuda", "NVCC_PREPEND_FLAGS=-ccbin=/home/zw193905/.conda_gcc/bin/x86_64-conda-linux-gnu-g++", "MOE_STRATEGY=mega_moe"],
                task_info="data/model/glm5/glm_5_fp8_q_r_h20_mtp.json",
                smoke_args="--fp8_kv_cache 0 --act_type BF16 --seq_size_per_block 64 --tp_size 1 --dp_size 4 --ep_size 4 --world_size 4 --warm_up 0 --reserver_runtime_mem_mb 8192 --sp_model_type glm_5_mtp --gen_num_per_cycle 3 --sp_type eagle --sp_checkpoint_path /home/zw193905/models/GLM-5-FP8 --sp_act_type bf16 --moe_strategy mega_moe --enable_cuda_graph 0",
                gpu_type=["H20"],
            ),
            smoke_test(
    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                smoke_args="--act_type BF16 --seq_size_per_block 2048 --tp_size 2 --max_seq_len 12800 --reserver_runtime_mem_mb 10000 --warm_up 0 --sp_model_type qwen35_moe_mtp --gen_num_per_cycle 4 --sp_type eagle --sp_checkpoint_path /mnt/nas1/hf/Qwen3.5-35B-A3B-FP8 --sp_act_type bf16 --concurrency_limit 4 --enable_cuda_graph 1 --decode_capture_config '1' --use_deepep_moe 1 --use_deepep_low_latency 1",
                envs=["ACCL_LOW_LATENCY_OPTIMIZE=1"],
                gpu_type=["H20"],
            ),
            smoke_test(
                ...
                smoke_args= {
                    ...
                    "decode": "--load_cache_timeout_ms 120000 --act_type BF16 --seq_size_per_block 2048 --tp_size 2 --max_seq_len 12800 --reserver_runtime_mem_mb 10000 --warm_up 0 --sp_model_type qwen35_moe_mtp --gen_num_per_cycle 4 --sp_type eagle --sp_checkpoint_path /mnt/nas1/hf/Qwen3.5-35B-A3B-FP8 --sp_act_type bf16 --concurrency_limit 4 --enable_cuda_graph 1 --decode_capture_config '1' --use_deepep_moe 1 --use_deepep_low_latency 1 --role_type DECODE --cache_store_rdma_mode 0 --use_local 1 --reuse_cache 1"
                },
                gpu_type=["H20"],
            ),
            smoke_test(
