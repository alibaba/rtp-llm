    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                smoke_args={
                    "prefill": "--act_type BF16 --reserver_runtime_mem_mb 8192 --tp_size 1 --world_size 1 --warm_up 0 --role_type PREFILL --cache_store_rdma_mode 1 --use_local 1 --seq_size_per_block 64 --reuse_cache 1 --load_cache_timeout_ms 120000",
                    "decode": "--act_type BF16 --reserver_runtime_mem_mb 8192 --tp_size 1 --world_size 1 --warm_up 0 --role_type DECODE --cache_store_rdma_mode 1 --use_local 1 --seq_size_per_block 64 --reuse_cache 1 --load_cache_timeout_ms 120000",
                },
                sleep_time_qr=10,
                gpu_type=["H20"],
            ),
            smoke_test(
                ...
                smoke_args={
                    "prefill": "--act_type BF16 --reserver_runtime_mem_mb 8192 --tp_size 2 --world_size 2 --warm_up 0 --role_type PREFILL --cache_store_rdma_mode 1 --use_local 1 --seq_size_per_block 64 --reuse_cache 1 --load_cache_timeout_ms 120000",
                    "decode": "--act_type BF16 --reserver_runtime_mem_mb 8192 --tp_size 2 --world_size 2 --warm_up 0 --role_type DECODE --cache_store_rdma_mode 1 --use_local 1 --seq_size_per_block 64 --reuse_cache 1 --load_cache_timeout_ms 120000",
                },
                sleep_time_qr=10,
                gpu_type=["H20"],
            ),
