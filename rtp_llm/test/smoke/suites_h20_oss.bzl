    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                task_info="data/model/qwen2_14b/q_r_mtp.json",
                smoke_args="--max_seq_len 320 --seq_size_per_block 64 --prefill_chunk_size 64 --disable_flash_infer 0 --ft_disable_custom_ar 1 --sp_type eagle --gen_num_per_cycle 4 --act_type FP16 --sp_model_type qwen_2-mtp --sp_checkpoint_path /mnt/nas1/mtp_reg/qwen2_14b_draft/ --reserver_runtime_mem_mb 21954 --tp_size 2",
                gpu_type=["H20"],
            ),
            smoke_test(
