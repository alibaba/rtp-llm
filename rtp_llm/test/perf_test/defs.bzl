load("//internal_source/rtp_llm/test/smoke:defs.bzl", "get_world_size_from_smoke_args")
...
def perf_test(name, model_type, ckpt_path, gpu_type,
    ...
    native.py_test(
        name = name,
        main = "//internal_source/rtp_llm/test/perf_test:test_entry.py",
        srcs = ["//internal_source/rtp_llm/test/perf_test:test_entry.py"],
        timeout = "eternal",
        deps = [
            "//rtp_llm:pyodps",
            "//rtp_llm:testlib",
