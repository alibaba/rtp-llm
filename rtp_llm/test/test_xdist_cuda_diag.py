...
class TestXdistCudaDiag:
    ...
    def test_env_vars(self):
        ...
        info = {
            ...
            "_RTP_TORCH_BEFORE_SLICE": os.environ.get("_RTP_TORCH_BEFORE_SLICE", "<NOT SET>"),
        }
    ...
    def test_cuda_init(self):
        ...
        if not is_avail:
            ...
            print(f"[DIAG_CUDA] torch.backends.cuda.is_built={torch.backends.cuda.is_built()}")
    ...
    def test_subprocess_cuda_visibility(self):
        ...
        assert result.returncode == 0, f"Subprocess CUDA check failed: {result.stderr[-500:]}"
