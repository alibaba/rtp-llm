...
class ModelTestBase(TestCase):
    ...
    def simple_test(self, is_fake: bool):
        ...
        try:
            ...
            expected_path = "rtp_llm/test/model_test/" + self.fake_name + "/testdata/" + self.model_type + model_str
            if not os.path.exists(expected_path):
                expected_path = "internal_source/rtp_llm/test/" + self.fake_name + "/testdata/" + self.model_type + model_str
            if self.test_loss:
