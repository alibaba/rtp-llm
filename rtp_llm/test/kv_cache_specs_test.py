...
class HybridKVCacheSpecTest(TestCase):
    ...
    def test_qwen3_next_40_layers_uses_full_and_linear_groups(self):
        layer_types = [
        ...
        self.assertEqual(set(tags), {"full", "linear"})
    ...
    def test_kimi_linear_uses_one_linear_group_across_hybrid_cycles(self):
    ...
    def test_kimi_linear_sparse_layers_share_one_linear_group(self):
        tags = self._kimi_post_build_tags(
            [
                HybridAttentionType.LINEAR,
                HybridAttentionType.NONE,
