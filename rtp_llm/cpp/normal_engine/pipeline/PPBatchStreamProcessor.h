...
private:
    ...
    absl::StatusOr<SamplingState>
    createSamplingState(const PPSamplingPlan& sampling_plan, int64_t stream_idx, int64_t sequence_offset) const;
    ...
    absl::Status dispatchMtpExecutionResult(const StreamGroups& stream_groups, const PPExecutionResult& result) const;
