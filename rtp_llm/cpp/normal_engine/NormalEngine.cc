...
WarmUpResult NormalEngine::prefillWarmUp(const EngineInitParams& params) {
    ...
    executor_.reset(new NormalExecutor(thread_pool_, params, nullptr, true, false, 0, mla_ops_type_));
...
WarmUpResult NormalEngine::decodeWarmUp(const EngineInitParams& params) {
    ...
    executor_.reset(new NormalExecutor(thread_pool_, params, cache_manager, true, false, 0, mla_ops_type_));
