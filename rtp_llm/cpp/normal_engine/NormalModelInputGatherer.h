...
struct NormalModelInputGathererConfig {
    ...
    // DSV4-only: per-layer list of gids the layer participates in.
    // Source is CacheConfig::layer_to_group_ids; empty for non-DSV4 models.
    std::vector<std::vector<int>> layer_to_group_ids_dpsk_v4;
