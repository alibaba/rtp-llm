...
NormalExecutor::NormalExecutor(const EngineInitParams&                params,
    ...
    const size_t runtime_tokens_per_block        = params.model_config_.attn_config.tokens_per_block;
    const size_t runtime_kernel_tokens_per_block = params.model_config_.attn_config.kernel_tokens_per_block > 0 ?
