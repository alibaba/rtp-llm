...
__attribute__((visibility("default"))) py::object convertTensorMapVectorToObject(const std::vector<std::map<std::string, torch::Tensor>>& tensor_map_vec);
...
__attribute__((visibility("default"))) std::vector<std::map<std::string, torch::Tensor>> pyListToTensorMapVec(py::list pyList);
