...
std::string KVCacheConfig::to_string() const {
    ...
    oss << "reuse_cache: " << reuse_cache << "\n"
        ...
        << "block_tree_host_evict_low_watermark_ratio: " << block_tree_host_evict_low_watermark_ratio << "\n"
        << "block_tree_host_evict_high_watermark_ratio: " << block_tree_host_evict_high_watermark_ratio << "\n"
