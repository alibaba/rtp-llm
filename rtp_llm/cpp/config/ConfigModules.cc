...
std::string KVCacheConfig::to_string() const {
    ...
    oss << "reuse_cache: " << reuse_cache << "\n"
        ...
        << "host_cache_sync_timeout_ms: " << host_cache_sync_timeout_ms << "\n"
...
std::string CacheStoreConfig::to_string() const {
    ...
    oss << "cache_store_rdma_mode: " << cache_store_rdma_mode << "\n"
        ...
        << "cache_store_tcp_worker_queue_size: " << cache_store_tcp_worker_queue_size << "\n"
        << "rdma_transfer_worker_thread_count: " << rdma_transfer_worker_thread_count << "\n"
        ...
        << "p2p_writeback_enable: " << p2p_writeback_enable << "\n"
        << "p2p_writeback_timeout_ms: " << p2p_writeback_timeout_ms << "\n"
        << "p2p_writeback_max_inflight: " << p2p_writeback_max_inflight << "\n";
    return oss.str();
}
