...
std::string HWKernelConfig::to_string() const {
    ...
    oss << "deep_gemm_num_sm: " << deep_gemm_num_sm << "\n"
        ...
        << "enable_rocm_vllm_custom_ar: " << enable_rocm_vllm_custom_ar << "\n"
        << "enable_rocm_quick_reduce: " << enable_rocm_quick_reduce << "\n"
        << "rocm_quick_reduce_quantization: " << rocm_quick_reduce_quantization;
    return oss.str();
}
