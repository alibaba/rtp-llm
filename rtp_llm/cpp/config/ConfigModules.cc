...
std::string KVCacheConfig::to_string() const {
    ...
    oss << "reuse_cache: " << reuse_cache << "\n"
        ...
        << "enable_memory_cache_disk_spill: " << enable_memory_cache_disk_spill << "\n"
        << "memory_cache_disk_paths: " << memory_cache_disk_paths << "\n"
        << "memory_cache_disk_init_timeout_ms: " << memory_cache_disk_init_timeout_ms << "\n"
        << "memory_cache_disk_stage_ack_timeout_ms: " << memory_cache_disk_stage_ack_timeout_ms << "\n"
        << "memory_cache_disk_spill_commit_timeout_ms: " << memory_cache_disk_spill_commit_timeout_ms << "\n"
        << "memory_cache_disk_segment_mb: " << memory_cache_disk_segment_mb << "\n"
        << "memory_cache_disk_align_bytes: " << memory_cache_disk_align_bytes << "\n"
        << "memory_cache_disk_io_threads_per_disk: " << memory_cache_disk_io_threads_per_disk << "\n"
        << "memory_cache_disk_queue_size_per_disk: " << memory_cache_disk_queue_size_per_disk << "\n"
        << "memory_cache_disk_direct_io: " << memory_cache_disk_direct_io << "\n"
        << "memory_cache_disk_direct_io_required: " << memory_cache_disk_direct_io_required << "\n"
        << "memory_cache_disk_drop_on_queue_full: " << memory_cache_disk_drop_on_queue_full << "\n"
        << "memory_cache_disk_max_inflight_bytes: " << memory_cache_disk_max_inflight_bytes << "\n"
        << "memory_cache_disk_max_inflight_bytes_per_disk: " << memory_cache_disk_max_inflight_bytes_per_disk << "\n"
        << "memory_cache_disk_max_sync_stage_us: " << memory_cache_disk_max_sync_stage_us << "\n"
        << "memory_cache_disk_metrics_report_interval_ms: " << memory_cache_disk_metrics_report_interval_ms << "\n"
        << "memory_cache_disk_max_staging_buffers_per_disk: " << memory_cache_disk_max_staging_buffers_per_disk << "\n"
