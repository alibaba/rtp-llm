...
struct KVCacheConfig {
    ...
    double                                  block_tree_device_evict_low_watermark_ratio     = 0.82;
    double                                  block_tree_device_evict_high_watermark_ratio    = 0.90;
    double                                  block_tree_host_evict_low_watermark_ratio       = 0.90;
    double                                  block_tree_host_evict_high_watermark_ratio      = 0.94;
    double                                  block_tree_disk_evict_low_watermark_ratio       = 0.92;
    double                                  block_tree_disk_evict_high_watermark_ratio      = 0.97;
