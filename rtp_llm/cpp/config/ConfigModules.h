...
struct KVCacheConfig {
    ...
    bool        enable_independent_pool      = false;  // Use independent block pool per cache group
    std::string pool_ratio;  // Colon-separated ratio for block pool memory distribution, e.g. "4:1"
