...
public:
    ...
    bool read(const ::rdma_transport::RdmaDescriptorPB& descriptor,
...
protected:
    ...
    MMRdmaOutputExporter makeAdapter(int64_t max_slot_bytes) {
        return MMRdmaOutputExporter(exporter, max_slot_bytes);
    }
