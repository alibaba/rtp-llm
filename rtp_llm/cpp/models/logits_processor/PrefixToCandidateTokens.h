...
public:
    ...
    bool Uint(unsigned u) {
        if (u > static_cast<unsigned>(std::numeric_limits<int32_t>::max())) {
            RTP_LLM_LOG_WARNING("SAX parser: Uint value %u overflows int32_t, skipping", u);
            return true;
        }
    ...
    bool Int64(int64_t i) {
        if (i < std::numeric_limits<int32_t>::min() || i > std::numeric_limits<int32_t>::max()) {
            RTP_LLM_LOG_WARNING("SAX parser: Int64 value %ld overflows int32_t, skipping", (long)i);
            return true;
        }
        return handleNumber(static_cast<int32_t>(i));
    }
    ...
    bool Uint64(uint64_t u) {
        if (u > static_cast<uint64_t>(std::numeric_limits<int32_t>::max())) {
            RTP_LLM_LOG_WARNING("SAX parser: Uint64 value %lu overflows int32_t, skipping", (unsigned long)u);
            return true;
        }
        return handleNumber(static_cast<int32_t>(u));
    }
