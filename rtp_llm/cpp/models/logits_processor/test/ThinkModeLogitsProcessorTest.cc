...
TEST_F(SamplerTest, testZeroThinkBudgetMasksThinkBeginAndAllowsThinkEndBeforeSampling) {
    SamplerDataBuilder builder;
...
TEST_F(SamplerTest, testZeroThinkBudgetAllowsThinkEndWithoutBeginTokenConfig) {
    SamplerDataBuilder builder;
