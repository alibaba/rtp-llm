...
GptModelOutputs PyWrappedModel::forward(const GptModelInputs& inputs) {
    ...
    try {
        ...
        if (int(device_props_.enable_layer_micro_batch)) {
            ...
            RTP_LLM_CHECK_WITH_INFO(
                whole_chunk_tokens <= 0 || !inputs.prefix_lengths.defined() || inputs.prefix_lengths.numel() == 0
        ...
        attention_inputs_.need_all_logits        = inputs.need_all_logits;
        attention_inputs_.need_all_hidden_states = inputs.need_all_hidden_states;
