    ...
    if (has_hidden_states) {
        ...
        if (model_input.last_hidden_states_layout == MtpHiddenStatesLayout::GLOBAL) {
            ...
            RTP_LLM_CHECK_WITH_INFO(total_hidden_states.size(0) == local_token_num,
                                    ...
                                    total_hidden_states.size(0),
                                    local_token_num);
        } else if (model_input.last_hidden_states_layout == MtpHiddenStatesLayout::NONE) {
            ...
            RTP_LLM_FAIL("CP MTP hidden states require GLOBAL, CP_LOCAL, or inferred NONE layout, rows=%ld, "
                         "global_tokens=%ld, local_tokens=%ld",
                         total_hidden_states.size(0),
                         global_token_num,
                         local_token_num);
