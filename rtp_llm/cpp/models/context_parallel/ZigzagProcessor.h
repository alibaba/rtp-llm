...
public:
    explicit ZigZagProcessor(const ParallelismConfig& parallelism_config, int cp_chunk_alignment = 1):
        IContextParallelProcessor(parallelism_config, cp_chunk_alignment) {}
