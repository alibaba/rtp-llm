...
class TpSyncModelInputsIntegrationTest(unittest.TestCase):
    ...
    def assertSyncedBatches(self, results, skip_run: bool) -> None:
    ...
    def test_root_flags_replace_empty_and_stale_non_root_inputs(self) -> None:
        ...
        for skip_run in (False, True):
            for initial_flags in (False, True):
                with self.subTest(skip_run=skip_run, initial_flags=initial_flags):
                    frames = []
                    ...
                    results = run_tp_sync_model_inputs_scenario(
                        0, 4, _TP_SYNC_CAPTURE_FLAGS, skip_run, initial_flags
                    )
