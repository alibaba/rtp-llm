...
private:
    ...
    // TODO: Bind deferred errors to a synchronized publish epoch so an
    // exceptional early return cannot leave one for a later batch to consume.
    // This round intentionally does not implement that cross-rank protocol.
