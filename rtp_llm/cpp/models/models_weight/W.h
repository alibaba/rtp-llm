...
static const std::string ffn_up            = "ffn_weights.intermediate_weight.kernel";
static const std::string ffn_up_b          = "ffn_weights.intermediate_weight.bias";
static const std::string ffn_gate          = "ffn_weights.intermediate_weight3.kernel";
static const std::string ffn_gate_b        = "ffn_weights.intermediate_weight3.bias";
static const std::string ffn_gate_up       = "ffn_weights.intermediate_weight13.kernel";
static const std::string ffn_gate_up_b     = "ffn_weights.intermediate_weight13.bias";
...
static const std::string ffn_down          = "ffn_weights.intermediate_weight2.kernel";
static const std::string ffn_down_b        = "ffn_weights.intermediate_weight2.bias";
...
static const std::string moe_gate_up              = "partial_moe_weights.intermediate_weight.kernel";
static const std::string moe_gate_up_b            = "partial_moe_weights.intermediate_weight.bias";
static const std::string moe_down                 = "partial_moe_weights.intermediate_weight2.kernel";
static const std::string moe_down_b               = "partial_moe_weights.intermediate_weight2.bias";
...
static const std::string ffn_up_z        = "ffn_weights.intermediate_weight.zero";
static const std::string ffn_up_s        = "ffn_weights.intermediate_weight.weight_only_quant_scale";
static const std::string ffn_up_s2       = "ffn_weights.intermediate_weight.weight_scale_2";
static const std::string ffn_up_i_s      = "ffn_weights.intermediate_weight.input_scale";
static const std::string ffn_gate_z      = "ffn_weights.intermediate_weight3.zero";
static const std::string ffn_gate_s      = "ffn_weights.intermediate_weight3.weight_only_quant_scale";
static const std::string ffn_gate_s2     = "ffn_weights.intermediate_weight3.weight_scale_2";
static const std::string ffn_gate_i_s    = "ffn_weights.intermediate_weight3.input_scale";
static const std::string ffn_gate_up_z   = "ffn_weights.intermediate_weight13.zero";
static const std::string ffn_gate_up_s   = "ffn_weights.intermediate_weight13.weight_only_quant_scale";
static const std::string ffn_act_s       = "ffn_weights.intermediate_weight2.act_quant_scale";
static const std::string ffn_gate_up_s2  = "ffn_weights.intermediate_weight13.weight_scale_2";
static const std::string ffn_gate_up_i_s = "ffn_weights.intermediate_weight13.input_scale";
static const std::string ffn_down_z      = "ffn_weights.intermediate_weight2.zero";
static const std::string ffn_down_s      = "ffn_weights.intermediate_weight2.weight_only_quant_scale";
static const std::string ffn_down_s2     = "ffn_weights.intermediate_weight2.weight_scale_2";
static const std::string ffn_down_i_s    = "ffn_weights.intermediate_weight2.input_scale";
static const std::string moe_gate_up_z   = "partial_moe_weights.intermediate_weight.zero";
static const std::string moe_gate_up_s   = "partial_moe_weights.intermediate_weight.weight_only_quant_scale";
static const std::string moe_gate_up_s2  = "partial_moe_weights.intermediate_weight.weight_scale_2";
static const std::string moe_gate_up_i_s = "partial_moe_weights.intermediate_weight.input_scale";
static const std::string moe_down_z      = "partial_moe_weights.intermediate_weight2.zero";
static const std::string moe_down_s      = "partial_moe_weights.intermediate_weight2.weight_only_quant_scale";
static const std::string moe_down_s2     = "partial_moe_weights.intermediate_weight2.weight_scale_2";
static const std::string moe_down_i_s    = "partial_moe_weights.intermediate_weight2.input_scale";
...
static const std::string ffn_up_act_scale   = "ffn_weights.intermediate_weight.act_quant_scale";
static const std::string ffn_down_act_scale = "ffn_weights.intermediate_weight2.act_quant_scale";  // same to ffn_act_s
static const std::string ffn_gate_act_scale = "ffn_weights.intermediate_weight3.act_quant_scale";
...
static const std::string ffn_up_act_scale_inv   = "ffn_weights.intermediate_weight.act_quant_scale_inv";
static const std::string ffn_down_act_scale_inv = "ffn_weights.intermediate_weight2.act_quant_scale_inv";
static const std::string ffn_gate_act_scale_inv = "ffn_weights.intermediate_weight3.act_quant_scale_inv";
}  // namespace W
}  // namespace rtp_llm
