...
enum class BlockZeroVariant : int {
    kLayerFused      = 0,   // grid=(bs),   normal stores
    kLayerFusedCG    = 1,   // grid=(bs),   st.global.cg (cache-bypass)
    kLayerParallel   = 2,   // grid=(bs,L), normal stores
    kLayerParallelCG = 3,   // grid=(bs,L), st.global.cg (cache-bypass)
};
