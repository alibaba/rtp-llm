...
#include <torch/all.h>
#include "moe_topk_softmax_kernels.h"
...
#define LAUNCH_SOFTMAX(NUM_EXPERTS, WARPS_PER_TB)                                                                      \
    topkGatingSoftmaxLauncherHelper<NUM_EXPERTS, WARPS_PER_TB>(gating_output,                                          \
                                                               nullptr,                                                \
                                                               topk_weights,                                           \
                                                               topk_indices,                                           \
                  ...
                  torch::Tensor& gating_output)         // [num_tokens, num_experts]
{
    ...
    topkGatingSoftmaxKernelLauncher(gating_output.data_ptr<float>(),
