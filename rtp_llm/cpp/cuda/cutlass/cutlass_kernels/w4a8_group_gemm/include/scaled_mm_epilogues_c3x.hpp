...
#include "rtp_llm/cpp/cuda/cutlass/cutlass_kernels/w4a8_group_gemm/include/broadcast_load_epilogue_array_c3x.hpp"
#include "rtp_llm/cpp/cuda/cutlass/cutlass_kernels/w4a8_group_gemm/include/broadcast_load_epilogue_c3x.hpp"
...
private:
    ...
    using Compute = cutlass::epilogue::fusion::Sm90Compute<cutlass::epilogue::thread::Identity,
                                                           ElementD,
                                                           ElementAcc,
...
protected:
    ...
    using ColLoad = cutlass::epilogue::fusion::Sm90ColBroadcast<0 /*Stages*/,
                                                                TileShape,
                                                                T,
                                                                T,
    ...
    // Don't want to support nullptr by default
    template<typename T, bool EnableNullPtr = false>
    using RowLoad = cutlass::epilogue::fusion::Sm90RowBroadcast<0 /*Stages*/,
                                                                TileShape,
                                                                T,
                                                                T,
