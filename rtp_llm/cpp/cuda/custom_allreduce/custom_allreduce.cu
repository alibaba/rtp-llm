...
int64_t
custom_ar_init(const std::vector<fptr_t>& fake_ipc_ptrs, torch::Tensor& rank_data, int64_t rank, bool full_nvlink) {
...
void custom_ar_register_graph_buffers(fptr_t                                   _fa,
