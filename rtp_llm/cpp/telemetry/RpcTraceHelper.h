...
// double-write follows the intended cross-language usage contract (the Python
// schema in rtp_llm/telemetry/attributes.py is aligned in a follow-up PR):
// current semconv input/output, legacy
