...
public:
    ...
    std::string debugString() const {
        ...
        debug_string << "GenerateConfig {"
                     ...
                     << ", reuse_cache: " << reuse_cache << ", enable_memory_block_cache: " << enable_memory_block_cache
                     << ", enable_device_cache: " << enable_device_cache
                     << ", enable_remote_cache: " << enable_remote_cache
                     << ", enable_memory_cache: " << enable_memory_cache << ", sync_wait_write: " << sync_wait_write
                     << "}";
