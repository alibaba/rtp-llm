...
FIFOScheduler::FIFOScheduler(const RuntimeConfig&                 runtime_config,
    ...
    reserve_block_num_(runtime_config.scheduler_reserve_resource_ratio * cache_manager->availableBlockNums() / 100),
    // not support fallback when use pd_speration:use_cache_store
    enable_partial_fallback_(runtime_config.enable_partial_fallback && pd_sep_config.role_type == RoleType::PDFUSION),
    ...
    fast_gen_max_context_len_(runtime_config.fast_gen_max_context_len),
