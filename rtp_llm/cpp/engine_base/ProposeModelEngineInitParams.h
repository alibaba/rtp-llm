...
struct ProposeModelEngineInitParams {
    ...
    ProposeModelEngineInitParams(size_t                  model_id,
        ...
        vanilla_model_params(new EngineInitParams(model_id,
                                                  model_config,
    ...
    bool draftModel() {
        return sp_type == SP_TYPE_VANILLA || sp_type == SP_TYPE_MTP || sp_type == SP_TYPE_EAGLE3
               || sp_type == SP_TYPE_EAGLE || sp_type == SP_TYPE_DSPARK;
    }
