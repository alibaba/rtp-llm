...
public:
    void showDebugInfo() const {
        ...
        RTP_LLM_LOG_INFO("ModelConfig: max_seq_len=%ld, vocab_size=%ld", model_config_.max_seq_len_, model_config_.vocab_size_);
        ...
        RTP_LLM_LOG_INFO("RuntimeConfig: max_generate_batch_size=%ld, max_context_batch_size=%ld", runtime_config.max_generate_batch_size, runtime_config.max_context_batch_size);
    }
