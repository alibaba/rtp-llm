...
bool RtpLLMRemoteCacheReadMetrics::init(kmonitor::MetricsGroupManager* manager) {
    REGISTER_QPS_MUTABLE_METRIC(remote_read_qps_metric, "remote_read_qps");
    REGISTER_QPS_MUTABLE_METRIC(remote_read_fail_qps_metric, "remote_read_fail_qps");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_reuse_block_num_metric, "remote_reuse_block_num");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_read_task_cost_time_us_metric, "remote_read_task_cost_time_us");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_match_time_us_metric, "remote_match_time_us");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_read_broadcast_time_us_metric, "remote_read_broadcast_time_us");
    return true;
}
...
void RtpLLMRemoteCacheReadMetrics::report(const kmonitor::MetricsTags*           tags,
    ...
    REPORT_MUTABLE_METRIC(remote_reuse_block_num_metric, collector->remote_reuse_block_num);
    ...
    REPORT_MUTABLE_METRIC(remote_read_broadcast_time_us_metric, collector->remote_read_broadcast_time_us);
}

bool RtpLLMRemoteCacheWriteMetrics::init(kmonitor::MetricsGroupManager* manager) {
    REGISTER_QPS_MUTABLE_METRIC(remote_write_qps_metric, "remote_write_qps");
    REGISTER_QPS_MUTABLE_METRIC(remote_write_fail_qps_metric, "remote_write_fail");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_write_cache_block_num_metric, "remote_write_cache_block_num");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_write_task_cost_time_us_metric, "remote_write_task_cost_time_us");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_get_write_location_time_us_metric, "remote_get_write_location_time_us");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_write_broadcast_time_us_metric, "remote_write_broadcast_time_us");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_finish_write_time_us_metric, "remote_finish_write_time_us");
    return true;
}
...
bool RtpLLMRemoteCacheSDKMetrics::init(kmonitor::MetricsGroupManager* manager) {
    REGISTER_QPS_MUTABLE_METRIC(remote_sdk_fail_qps_metric, "remote_sdk_fail_qps");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_sdk_block_num_metric, "remote_sdk_block_num");
    REGISTER_GAUGE_MUTABLE_METRIC(remote_sdk_cost_time_us_metric, "remote_sdk_cost_time_us");
    return true;
}
