...
public:
    ...
    bool                                 cache_schedule_target    = false;
    std::optional<CacheScheduleSnapshot> cache_schedule;
...
public:
    ...
    void reportCacheScheduleMetrics(const kmonitor::MetricsTags* tags, const CacheScheduleSnapshot& snapshot);
