...
public:
    ...
    static BlockPoolConfig createConfig(const CacheConfig& cache_config) {
        ...
        MemoryLayoutConfig main_layout = createMemoryLayoutConfig(is_hybrid, layer_num, main_spec, cache_config);
        ...
        for (size_t i = 0; i < cache_config.mtp_sub_configs.size(); ++i) {
            ...
            MemoryLayoutConfig mtp_layout = createMemoryLayoutConfig(false, mtp_layer_num, mtp_spec, cache_config);
