...
void LinearKVCacheGroup::removeSkippedBlocksBefore(BlockIds& block_ids, int prefix_len, bool enable_reuse_cache) {
...
void LinearKVCacheGroup::removeSkippedBlocksThrough(BlockIds& block_ids, int last_position, bool enable_reuse_cache) {
