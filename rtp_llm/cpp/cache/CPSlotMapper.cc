...
std::optional<size_t> CPSlotMapper::localPhysicalBlockPosition(const CacheGroupPolicy& policy,
                                                               size_t                  logical_position,
                                                               size_t                  logical_count) const {
    return physicalBlockPosition(policy, logical_position, logical_count, cp_rank_, cp_size_);
}
