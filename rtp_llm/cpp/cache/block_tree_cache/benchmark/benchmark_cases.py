...
Transfer profile families:
- mixed-direction medium pairs, including Device<->Host concurrency variants
- single-direction batch API matrices generated by _batch_api_matrix_cases
- business/worker concurrency matrices generated by _e2e_business_cases
All are registered in the profile suite. See docs/benchmark_cases.md for
selection, matrix dimensions, and interpretation; report layout is independent
of registry names.
"""
...
def _transfer_case(
    ...
    if device_disk_staging_block_count is not None:
        params["--device-disk-staging-block-count"] = str(
