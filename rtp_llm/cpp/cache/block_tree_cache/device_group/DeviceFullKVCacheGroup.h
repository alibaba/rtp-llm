...
class DeviceFullKVCacheGroup: public DeviceKVCacheGroup {
public:
    DeviceFullKVCacheGroup(const LayerIdsType&                 layer_ids,
...
using DeviceFullKVCacheGroupPtr = std::shared_ptr<DeviceFullKVCacheGroup>;
