...
public:
    ...
    BlockAddrInfo          convertIndexToAddr(int block_index, int layer_id, KVCacheAttnType attn_type) const;
    std::vector<BlockInfo> convertIndexToBuffer(int block_index, int layer_id, KVCacheAttnType attn_type) const;
    std::vector<BlockInfo>
    convertIndexToBuffer(int block_index, int layer_id, KVCacheAttnType attn_type, int partition_count, int partition_id) const;
