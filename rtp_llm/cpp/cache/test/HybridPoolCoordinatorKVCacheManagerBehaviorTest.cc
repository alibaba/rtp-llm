...
// mergeMtpModule (CacheConfigCreator.cc:258) rejects a propose group whose physical layout differs
...
// mergeMtpModule (CacheConfigCreator.cc:264) rejects a matched propose group that does not cover every
