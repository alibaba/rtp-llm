...
TEST_F(KVCacheManagerTest, MaxSequenceLengthKeepsGlobalCapacityUnderCP) {
    ...
    EXPECT_EQ(kv_cache_manager->maxSequenceLength(), physical_capacity);
    EXPECT_EQ(kv_cache_manager->maxSequenceLength(), (cache_config.blockNum() - 1) * cache_config.seq_size_per_block);
}
