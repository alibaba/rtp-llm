...
// reason.
//
// Scope: this is a SINGLE-RANK budget derived from that rank's own measurement. Under MoE
// warmup skew the ranks measure deliberately different peaks; cluster agreement comes from
// KVCacheManager::allocateAndSync reducing block_num with std::min across the world.
//
