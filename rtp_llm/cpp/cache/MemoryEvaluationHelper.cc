...
rtp_llm::DataType MemoryEvaluationHelper::getDataTypeForCache(const ModelConfig& model_config, const rtp_llm::DeviceProperties& device_prop) {
    auto dtype =
...
size_t MemoryEvaluationHelper::getKVCacheMemorySize(const RuntimeConfig&                             runtime_config,
    ...
    size_t env_runtime_required_bytes =
        MemoryEvaluationHelper::getDefaultRuntimeMemorySize(runtime_config, parallelism_config, model_config, sp_config);
