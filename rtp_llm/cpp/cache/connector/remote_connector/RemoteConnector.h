...
private:
    ...
    inline void set_replication_hints(std::vector<kv_cache_manager::ReplicationHint>&& hints) {
        replication_hints_ = std::move(hints);
    }
    inline const std::vector<kv_cache_manager::ReplicationHint>& replication_hints() const {
    ...
    std::vector<kv_cache_manager::ReplicationHint> replication_hints_;
