...
public:
    ...
    void setPrefillReuseLength(int reuse_length, int local_reuse_length, int remote_reuse_length, int memory_reuse_length) {
        std::lock_guard<std::mutex> lock(mutex_);
...
public:
    ...
    bool enableMemoryCache() const override { return false; }
    bool enableRemoteCache() const override { return false; }
    const std::string& trace_id() const override { static const std::string s; return s; }
    const std::string& unique_id() const override { static const std::string s; return s; }
    const std::vector<int64_t>& tokens() const override { static const std::vector<int64_t> v; return v; }
