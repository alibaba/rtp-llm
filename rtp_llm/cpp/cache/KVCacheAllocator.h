...
public:
    ...
    virtual BlockAddrInfo          convertIndexToAddr(int layer_id, KVCacheAttnType attn_type, int block_id) const;
    virtual std::vector<BlockInfo> convertIndexToBuffer(int layer_id, KVCacheAttnType attn_type, int block_id) const;
