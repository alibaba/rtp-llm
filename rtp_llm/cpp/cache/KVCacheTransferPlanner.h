...
// Decode may reserve destination slots for speculative tokens that are not
// present in the prefill cache-key namespace yet. Restrict load positions to
// the shared logical prefix before selecting hybrid tail blocks.
