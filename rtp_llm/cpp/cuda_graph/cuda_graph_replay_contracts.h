...
inline bool hasRequestOwnedMultimodalSignals(bool has_multimodal_features,
                                             bool has_multimodal_locs,
                                             bool has_multimodal_extra,
                                             bool has_text_tokens_mask) {
    return has_multimodal_features || has_multimodal_locs || has_multimodal_extra || has_text_tokens_mask;
}
