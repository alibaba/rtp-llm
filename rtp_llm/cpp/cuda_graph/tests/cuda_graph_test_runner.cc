...
public:
    void init_prefill(py::object       py_instance,
        ...
        params.num_tokens_per_bs            = static_cast<int>(num_tokens_per_bs == 0 ? max_seq_len : num_tokens_per_bs);
        params.is_mtp_draft_update          = is_mtp_draft_update;
    ...
    void init_decode(py::object       py_instance,
        ...
        params.kv_cache_group_num           = kv_cache_group_num;
...
PYBIND11_MODULE(libtest_cuda_graph_runner, m) {
    ...
    py::class_<CudaGraphTestRunner>(m, "CudaGraphRunner")
        ...
        .def("init_prefill",
             ...
             py::arg("is_mtp_draft_update") = false)
        .def("init_decode",
             ...
             py::arg("kv_cache_layer_to_group") = std::vector<int32_t>{},
