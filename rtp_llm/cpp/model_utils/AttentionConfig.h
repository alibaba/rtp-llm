...
struct AttentionConfigs {
    ...
    int  indexer_topk     = 0;
    // Compressed-indexer geometry. indexer_topk is the number of compressed
    // groups selected by the indexer; sparse_attention_topk is the raw-token
    // width consumed by sparse MLA after group expansion and tail insertion.
