...
FfnLayerOutput CudaDevice::moeFfnFp8(const FfnLayerParams& params, const MoeGateSelectOutput& gate_outputs) {
    ...
    size_t total_padding_num = padding_size * num_experts_per_node;
    ...
    auto   padding_group_index = allocateBuffer({DataType::TYPE_INT32, {total_padding_num}}, {"padding_group_index"});
    ...
    doActivationContiguous_V2<GemmOutputType, ScaleBiasType>(
