...
BufferPtr getSemaphores(CudaDevice* device,
                        size_t      kv_head_num,
...
void runXqa(void*       input,
    ...
    static BufferPtr semaphores =
        getSemaphores(device, kv_head_num, max_batch_size, max_q_len, group_size, is_context_attn);
