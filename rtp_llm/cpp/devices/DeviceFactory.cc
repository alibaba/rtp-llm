...
void DeviceFactory::initDevices(const ParallelismConfig& parallelism_config,
    ...
    device_params.use_all_gather                 = parallelism_config.use_all_gather;
    ...
    device_params.tokens_per_block               = model_config.seq_size_per_block_;
    device_params.mla_ops_type                   = model_config.mla_ops_type_;
    device_params.max_seq_len                    = model_config.max_seq_len_;
    device_params.hidden_size                    = model_config.hidden_size_;
    device_params.num_experts                    = model_config.expert_num_;
    device_params.extra_experts                  = eplb_config.phy_exp_num - model_config.expert_num_;
    ...
    // FIFOSchedulerConfig fields are now in RuntimeConfig, no need to copy separately
