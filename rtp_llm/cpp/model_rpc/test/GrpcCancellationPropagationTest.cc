...
public:
    ::grpc::Status RemoteGenerate(::grpc::ServerContext*                                            context,
        ...
        cv_.notify_all();
        return ::grpc::Status(::grpc::StatusCode::CANCELLED, "downstream cancelled");
    }
...
public:
    ...
    ::grpc::Status GenerateStreamCall(::grpc::ServerContext*              context,
        ...
        const bool        got_output = stream->Read(&response);

        markReturned(got_output ? ::grpc::StatusCode::OK : ::grpc::StatusCode::CANCELLED,
                     got_output ? "output" : "read returned false");
        return got_output ? ::grpc::Status::OK :
                            ::grpc::Status(::grpc::StatusCode::CANCELLED, "downstream ended");
    }
