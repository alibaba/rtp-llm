...
EngineInitParams createMockEngineInitParams(DeviceBase* device) {
    ...
    for (int i = 0; i < model_config.num_layers; ++i) {
        ...
        weights.emplace(W::ffn_gate, std::move(ffn_weight));
        weights.emplace(W::ffn_gate_b, std::move(ffn_weight_beta));
        weights.emplace(W::ffn_down, std::move(ffn_output_weight));
        weights.emplace(W::ffn_down_b, std::move(ffn_output_weight_beta));
...
std::array<loraLayerMap, 2> createMockLoraWeights(DeviceBase* device) {
    ...
    for (int i = 0; i < num_layers_; ++i) {
        ...
        weights_lora_a.emplace(W::ffn_gate, std::move(ffn_weight_lora_a));
        weights_lora_a.emplace(W::ffn_down, std::move(ffn_output_weight_lora_a));
        ...
        weights_lora_b.emplace(W::ffn_gate, std::move(ffn_weight_lora_b));
        weights_lora_b.emplace(W::ffn_down, std::move(ffn_output_weight_lora_b));
