...
TEST_F(PrefillRpcServerTest, mergeCacheReuseInfoKeepsColdPrefillUsage) {
    ...
    PrefillRpcServer::mergeCacheReuseInfo(aux_info, 0, 0, 0, 0, 1);
...
TEST_F(PrefillRpcServerTest, mergeCacheReuseInfoKeepsLongerPrefillPrefixWithoutAddingPhases) {
    ...
    PrefillRpcServer::mergeCacheReuseInfo(aux_info, 1536, 1536, 0, 1536, 2);
...
TEST_F(PrefillRpcServerTest, mergeCacheReuseInfoPrefersPrefillAttributionOnEqualPrefix) {
    ...
    PrefillRpcServer::mergeCacheReuseInfo(aux_info, 512, 512, 0, 512, 2);
...
TEST_F(PrefillRpcServerTest, mergeCacheReuseInfoPreservesPrefillAttributionForSingleGroup) {
    AuxInfoPB aux_info;
    aux_info.set_total_reuse_len(1280);
    aux_info.set_local_reuse_len(1280);

    PrefillRpcServer::mergeCacheReuseInfo(aux_info, 128, 0, 128, 0, 1);
...
TEST_F(PrefillRpcServerTest, mergeCacheReuseInfoUsesLongerDecodePrefixForMultiGroup) {
    AuxInfoPB aux_info;
    aux_info.set_total_reuse_len(1280);
    aux_info.set_local_reuse_len(1280);

    PrefillRpcServer::mergeCacheReuseInfo(aux_info, 128, 0, 128, 0, 2);

    EXPECT_EQ(aux_info.total_reuse_len(), 1280);
    EXPECT_EQ(aux_info.local_reuse_len(), 1280);
