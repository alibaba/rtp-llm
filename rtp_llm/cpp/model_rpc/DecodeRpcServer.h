...
private:
    ...
    // Report a terminal failure to FlexLB via meta_->finishTask(); guaranteed at most once per request.
    void reportEarlyFinishTask(DecodeGenerateContext& decode_context);
