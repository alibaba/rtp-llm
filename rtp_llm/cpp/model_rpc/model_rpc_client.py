        ...
        if aux_info_flag and len(output_pb.aux_info) > i:
            ...
            if aux_info_pb.HasField("pd_latency"):
                ...
                pd_latency = PDLatencyBreakdown(
                    ...
                    admission_prepare_us=pd_latency_pb.admission_prepare_us,
                    admission_prepare_wait_us=pd_latency_pb.admission_prepare_wait_us,
                    decode_normal_load_us=pd_latency_pb.decode_normal_load_us,
                    decode_ring_load_us=pd_latency_pb.decode_ring_load_us,
                    decode_first_token_us=pd_latency_pb.decode_first_token_us,
