...
MultimodalInput MMRpcCodec::transMMInputElement(const MultimodalInputPB& input_pb, torch::Tensor tensor) {
...
MultimodalInputsPB MMRpcCodec::transMMInputsPB(const std::vector<MultimodalInput> mm_inputs) {
...
ErrorResult<MultimodalOutput> MMRpcCodec::transMMOutput(const MultimodalOutputPB* output_pb) {
...
void MMRpcCodec::transMMPreprocessConfig(MMPreprocessConfigPB* config_pb, const MMPreprocessConfig& config) {
