...
MultimodalInput MultimodalPbConverter::inputFromPb(const MultimodalInputPB& input_pb, torch::Tensor tensor) {
    const auto& mm_preprocess_config = input_pb.mm_preprocess_config();
    ...
    return MultimodalInput(input_pb.multimodal_url(),
                           tensor,
                           input_pb.multimodal_type(),
