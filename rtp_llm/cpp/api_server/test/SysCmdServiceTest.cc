        ...
        const std::string        body = R"del(
{
    "log_level": "INFO"
        ...
        cmd_service_->setLogLevel(writer_ptr, request);
        EXPECT_TRUE(logger.isLevelEnabled(alog::LOG_LEVEL_INFO));
        EXPECT_FALSE(logger.isLevelEnabled(alog::LOG_LEVEL_DEBUG));
    }
        ...
        const std::string        body = R"del(
{
    "log_level": "DEBUG"
        ...
        cmd_service_->setLogLevel(writer_ptr, request);
        EXPECT_TRUE(logger.isLevelEnabled(alog::LOG_LEVEL_DEBUG));
        EXPECT_FALSE(logger.isLevelEnabled(alog::LOG_LEVEL_TRACE1));
    }
        ...
        const std::string        body = R"del(
{
    "log_level": "TRACE"
        ...
        cmd_service_->setLogLevel(writer_ptr, request);
        EXPECT_TRUE(logger.isLevelEnabled(alog::LOG_LEVEL_TRACE1));
    }
