...
void RtpEmbeddingOp::init(py::object model,
    ...
    try {
        ...
        int64_t model_rpc_port     = params.worker_ports.model_rpc_port;
        int64_t embedding_rpc_port = params.worker_ports.embedding_rpc_server_port;
...
void RtpEmbeddingOp::startHttpServer(std::shared_ptr<EmbeddingEngine>     embedding_engine,
    ...
    int64_t     http_port = params.worker_ports.http_port;
