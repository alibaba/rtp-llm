...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<FIFOSchedulerConfig>(m, "FIFOSchedulerConfig")
        ...
        .def_readwrite("context_batch_coalescing_window_ms",
                       &FIFOSchedulerConfig::context_batch_coalescing_window_ms)
        ...
        .def(py::pickle(
            [](const FIFOSchedulerConfig& self) {
                return py::make_tuple(self.max_context_batch_size,
                                      ...
                                      self.context_batch_coalescing_window_ms);
            },
            [](py::tuple t) {
                ...
                try {
                    ...
                    if (t.size() == 3) {
                        c.context_batch_coalescing_window_ms = t[2].cast<int64_t>();
                    }
                } catch (const std::exception& e) {
