...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<ModelConfig>(m, "ModelConfig")
        ...
        .def_readwrite("dsv41_model_revision", &ModelConfig::dsv41_model_revision)
        .def_readwrite("dsv41_replay_mode", &ModelConfig::dsv41_replay_mode)
        .def_readwrite("dsv41_tail_policy_version", &ModelConfig::dsv41_tail_policy_version)
