...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<AttentionConfigs>(m, "AttentionConfigs")
        ...
        // DeepSeek-V4 hybrid attention fields
        .def_readwrite("layer_compress_ratios", &AttentionConfigs::layer_compress_ratios)
        .def_readwrite("use_v4_hybrid_attn", &AttentionConfigs::use_v4_hybrid_attn)
        ...
        .def_readwrite("has_attention_sink", &AttentionConfigs::has_attention_sink)
