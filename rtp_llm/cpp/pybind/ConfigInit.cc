...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<GrammarConfig>(m, "GrammarConfig")
        ...
        .def_readwrite("response_completion_boundary_token_ids", &GrammarConfig::response_completion_boundary_token_ids)
        .def_readwrite("completion_think_close_token_ids", &GrammarConfig::completion_think_close_token_ids)
        .def_readwrite("completion_response_open_token_ids", &GrammarConfig::completion_response_open_token_ids)
        .def_readwrite("completion_response_close_token_ids", &GrammarConfig::completion_response_close_token_ids)
        .def_readwrite("completion_tools_open_token_ids", &GrammarConfig::completion_tools_open_token_ids)
        .def_readwrite("completion_tools_close_token_ids", &GrammarConfig::completion_tools_close_token_ids)
        .def_readwrite("completion_whitespace_token_ids", &GrammarConfig::completion_whitespace_token_ids)
        .def("to_string", &GrammarConfig::to_string)
        .def(py::pickle(
            [](const GrammarConfig& self) {
                if (!self.hasPretokenizedChatConstraints()) {
                    // Preserve the legacy pickle shape for models that do not
                    // opt in to pre-tokenized chat constraints.
                ...
                if (self.completion_think_close_token_ids.empty() && self.completion_response_open_token_ids.empty()
                    && self.completion_response_close_token_ids.empty() && self.completion_tools_open_token_ids.empty()
                    && self.completion_tools_close_token_ids.empty() && self.completion_whitespace_token_ids.empty()) {
                    return py::make_tuple(self.grammar_backend,
                                          self.constrained_json_disable_any_whitespace,
                                          self.num_workers,
                                          self.tokenizer_info_json,
                ...
                return py::make_tuple(self.grammar_backend,
                                      ...
                                      self.reasoning_completion_boundary_token_ids,
                                      self.response_completion_boundary_token_ids,
                                      self.completion_think_close_token_ids,
                                      self.completion_response_open_token_ids,
                                      self.completion_response_close_token_ids,
                                      self.completion_tools_open_token_ids,
                                      self.completion_tools_close_token_ids,
                                      self.completion_whitespace_token_ids);
            },
            [](py::tuple t) {
                if (t.size() != 5 && t.size() != 9 && t.size() != 11 && t.size() != 17)
                    throw std::runtime_error("Invalid state!");
                GrammarConfig c;
                try {
                    ...
                    if (t.size() == 17) {
                        c.completion_think_close_token_ids    = t[11].cast<std::vector<int32_t>>();
                        c.completion_response_open_token_ids  = t[12].cast<std::vector<int32_t>>();
                        c.completion_response_close_token_ids = t[13].cast<std::vector<int32_t>>();
                        c.completion_tools_open_token_ids     = t[14].cast<std::vector<int32_t>>();
                        c.completion_tools_close_token_ids    = t[15].cast<std::vector<int32_t>>();
                        c.completion_whitespace_token_ids     = t[16].cast<std::vector<int32_t>>();
                    }
                } catch (const std::exception& e) {
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) {
                ...
                try {
                    ...
                    c.mm_rdma_max_slot_bytes     = t[9].cast<int64_t>();
                } catch (const std::exception& e) {
