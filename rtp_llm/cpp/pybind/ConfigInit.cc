...
PYBIND11_MODULE(libth_transformer_config, m) {
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) {
                ...
                try {
                    ...
                    c.fp8_kv_cache_scale_mode              = t[11].cast<std::string>();
    ...
    py::class_<AttentionConfigs>(m, "AttentionConfigs")
        ...
        .def_readwrite("fp8_kv_cache_scale_mode", &AttentionConfigs::fp8_kv_cache_scale_mode)
