...
PYBIND11_MODULE(libth_transformer_config, m) {
    ...
    py::class_<KVCacheConfig>(m, "KVCacheConfig")
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) {
                constexpr size_t kFieldCount = 61;
                ...
                c.kv_cache_event_publisher_type = value(56).cast<std::string>();
                c.kv_cache_event_manager_endpoint = value(57).cast<std::string>();
                c.kv_cache_event_instance_group = value(58).cast<std::string>();
                c.kv_cache_event_instance_id = value(59).cast<std::string>();
                c.kv_cache_event_host_ip_port = value(60).cast<std::string>();
                return c;
            }));
