...
// // HybridPoolKVCacheAllocator is used for model with different kinds of attentions
// // and each kind of attentions has its own block_pool.

// class HybridPoolKVCacheAllocator public KVCacheAllocator {
// public:
//     HybridPoolKVCacheAllocator(const CacheConfig& config, rtp_llm::DeviceBase* device, AllocationType atype = AllocationType::DEVICE);
//     bool init() {
