...
public:
     ...
     */
    static BlockPoolConfig createKVFirstConfig(uint32_t layer_num, uint32_t block_num, uint32_t k_block_size, uint32_t v_block_size) {
        ...
        RTP_LLM_LOG_INFO("create KVFirstConfig: layer_num=%d, block_num=%d, k_block_size=%d, v_block_size=%d, total_size=%zu",
                         layer_num,
                         block_num,
                         k_block_size,
                         v_block_size,
