...
public:
    FullKVCacheGroup(const std::vector<int>& layer_ids, 
        ...
        : KVCacheGroup(layer_ids, group_spec, block_pool), block_cache_(std::move(block_cache)) {}
    ...
    void insertIntoCache(std::vector<CacheKeyType> cache_keys, std::vector<BlockIdxType> block_indices) override;
