...
protected:
    ...
    BlockPoolConfig createTestConfig(MemoryLayout layout, 
...
TEST_F(KVFirstLayoutStrategyTest, KVBlockSequentiality) {
    ...
    size_t k_layer_offset = reinterpret_cast<size_t>(layer1_block0.k_addr) - 
                           reinterpret_cast<size_t>(layer0_block0.k_addr);
    size_t v_layer_offset = reinterpret_cast<size_t>(layer1_block0.v_addr) - 
                           reinterpret_cast<size_t>(layer0_block0.v_addr);
