...
public:
    RemoteConnector(const CacheConfig&                cache_config,
                    ...
                    uint32_t                          linear_attention_write_interval = 0,  // for linear attention
...
class RemoteConnectorAsyncContext: public KVCacheConnector::AsyncContext {
public:
    enum class State {
        RCS_INIT    = 0,
        RCS_START   = 1,
...
private:
    ...
    RemoteConnectorAsyncContext(std::future<void> future);
