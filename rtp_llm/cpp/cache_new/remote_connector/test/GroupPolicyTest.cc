...
private:
    ...
    void test_FullLinearLayerGroupPolicy_filterNeedWriteGroups_interval_2() {
        {
            ...
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, 6, 7}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, 11}}));
        ...
        }
        {
            ...
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, 6, 7, 21}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, 11, 22}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        {  // exist empty block
            ...
            resource->cache_keys = {0, 1, 2, 3};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{-1, -1, -1, 7}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{-1, -1, -1, 11}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        {  // exist empty block
            ...
            resource->cache_keys = {0, 1, 2, 3};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, -1, 6, 7}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, -1, 10, 11}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        }
        {
            ...
            resource->cache_keys = {0, 1, 2, 3};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, 6, -1}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, -1}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        {  // exist empty block
            ...
            resource->cache_keys = {0, 1, 2, 3, 4};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, -1, 7, 21}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, -1, 11, 22}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        {  // exist empty block
            ...
            resource->cache_keys = {0, 1, 2, 3, 4};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, -1, -1, 7, 21}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, -1, -1, 11, 22}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        {  // exist empty block
            ...
            resource->cache_keys = {0, 1, 2, 3};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{-1, 5, -1, 7}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{-1, 9, -1, 11}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
            std::vector<std::string> expected = {"F0", "F0L1L2", "F0", "F0L1L2"};
            ASSERT_EQ(expected, real);
        ...
        {  // edge case
            ...
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{1}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{2}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
    ...
    void test_FullLinearLayerGroupPolicy_filterNeedWriteGroups_interval_1() {
        ...
        }
        {
            ...
            resource->cache_keys = {0, 1, 2, 3, 4};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, 6, -1, 21}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, -1, 22}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
        ...
        }
        {
            ...
            resource->cache_keys = {0};
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4}}));
            resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8}}));
            std::vector<std::string> real;
            ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
            std::vector<std::string> expected = {};
            ASSERT_EQ(expected, real);
...
TEST_F(GroupPolicyTest, test_FullLinearLayerGroupPolicy_filterNeedWriteGroups_fail) {
    ...
    {  // incomplete block
        ...
        resource->cache_keys = {0, 1, 2, 3, 4};
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, -1, 6, 7, -1}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, 11, -1}}));
        std::vector<std::string> real;
    ...
    {  // invalid group size
        ...
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, 5, 6, 7, 21}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, 10, 11, 22}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{12, 13, 14, 15, 23}}));
        std::vector<std::string> real;
        ASSERT_FALSE(group_policy_->getNeedWriteGroups(resource, real));
    }
}
...
TEST_F(GroupPolicyTest, test_DefaultLayerGroupPolicy_filterNeedWriteGroups_success) {
    ...
    }
    {
        ...
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{0, 1, 2, 3, 20, -1}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{4, -1, 6, 7, -1, 21}}));
        resource->group_block_ids.push_back(std::shared_ptr<BlockIds>(new BlockIds{{8, 9, -1, 11, -1, 22}}));
        std::vector<std::string> real;
        ASSERT_TRUE(group_policy_->getNeedWriteGroups(resource, real));
