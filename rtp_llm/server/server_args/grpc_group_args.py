...
_DASH_SC_DEFAULT_SERVER_RECV_BYTES = DEFAULT_DASH_SC_GRPC_MAX_MESSAGE_BYTES
...
def init_model_grpc_group_args(parser, grpc_config):
    ...
    grpc_group.add_argument(
        ...
        help='gRPC configuration as JSON string. Format: {"client_config": {...}, "server_config": {...}, "max_server_pollers": 4}',
    )
