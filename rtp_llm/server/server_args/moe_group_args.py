...
def init_moe_group_args(parser, moe_config, py_eplb_config, deep_ep_config):
    ##############################################################################################################
    # MOE 特性
    ##############################################################################################################
    ...
    moe_group.add_argument(
        "--eplb_mode",
        env_name="EPLB_MODE",
        bind_to=(py_eplb_config, 'eplb_mode'),
        type=str,
        default="NONE",
        help="专家并行的负载均衡模式",
    )
    moe_group.add_argument(
        ...
        bind_to=(py_eplb_config, 'eplb_update_time'),
        type=int,
        default=5000,
        help="专家并行复杂均衡的更新时间",
    )
    moe_group.add_argument(
        ...
        bind_to=(py_eplb_config, 'redundant_expert'),
        type=int,
        default=0,
        help="冗余专家个数",
    )
    moe_group.add_argument(
        ...
        bind_to=(py_eplb_config, 'balance_method'),
        type=str,
        default="mix",
        help="负载均衡的方法",
    )
    moe_group.add_argument(
        ...
        bind_to=(py_eplb_config, 'eplb_force_repack'),
        type=int,
        default=0,
    ...
    moe_group.add_argument(
        ...
        bind_to=(py_eplb_config, 'eplb_stats_window_size'),
        type=int,
        default=10,
        help="负载均衡的统计窗口大小",
    )
