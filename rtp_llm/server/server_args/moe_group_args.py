...
def init_moe_group_args(parser, moe_config, eplb_config, deep_ep_config):
    ...
    moe_group.add_argument(
        ...
        help=(
            ...
            "并要求 ep_size=1、dp_size=1；普通纯 TP 支持 tp_size>=1。"
            "启用 prefill CP 时，物理 tp_size 可大于 1，逻辑 MoE tp_size=1。"
        ),
    )
    moe_group.add_argument(
        "--fp4_moe_op",
        ...
        help=(
            ...
            "sm_120/121 的 flashinfer b12x，要求 ep_size=1、dp_size=1；"
            "普通纯 TP 支持 tp_size>=1。启用 prefill CP 时，物理 tp_size 可大于 "
            "1，逻辑 MoE tp_size=1。"
