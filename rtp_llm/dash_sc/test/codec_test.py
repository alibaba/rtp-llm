...
class StreamResponseBuilderTest(TestCase):
    ...
    def test_capacity_error_uses_use_parameter_status(self) -> None:
        ...
        the DashScope api-server passes the explicit status_code=429 through
        ...
        self.assertEqual(DASH_ERROR_CAPACITY.status_code, 429)
        self.assertEqual(DASH_ERROR_CAPACITY.error_no, LLMFinishReason.TASK_LIST_FULL)
        self.assertEqual(DASH_ERROR_CAPACITY.status_name, "TooManyRequests")
