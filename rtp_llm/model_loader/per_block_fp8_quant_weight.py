...
class PerBlockFp8Weight(CompositeWeight, QuantWeight):
    ...
    def _postprocess(
        ...
        if self.scale is not None:
            ...
            if (
                is_deep_gemm_e8m0_used()
                and scale_weight.dtype != torch.int32
                and not skip_moe_scale_repack
            ):
...
class LoadQuantPerBlockFp8Weight(PerBlockFp8Weight):
    ...
    def _load_raw_tensor(
        ...
        if direct_ue8m0:
            ...
            # AtomicWeight already merged HF Q/K/V [N_i, K] into [K, N].
            # Quantization and the head splitters below consume [N, K].
