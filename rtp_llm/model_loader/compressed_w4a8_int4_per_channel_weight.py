...
def _build_compressed_ckpt_weights(src_weights, suffix: str) -> list:
    new_weights = []
...
class LoadCompressedW4A8Int4PerGroupQuantWeight(CompositeWeight, QuantWeight):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kernel: AtomicWeight = create_w8a8_fp8_weight(src_weight_info, **kernel_params)
    ...
    def _load_raw_tensor(
        ...
        K = packed_k * 2
        assert scale_tensor.shape == (E, N, K // self.group_size), (
