...
class FastsafetensorsMemoryTest(unittest.TestCase):
    def setUp(self):
        ...
        self.loader._fastsafetensors_transient_budget_bytes = Mock(
            side_effect=lambda size: 3 * size
        )
    ...
    def test_bounded_budget_replaces_whole_shard_estimate(self):
        self.loader._fastsafetensors_transient_budget_bytes.side_effect = None
        self.loader._fastsafetensors_transient_budget_bytes.return_value = 512 * _MIB
        self._assert_boundary(10752)
