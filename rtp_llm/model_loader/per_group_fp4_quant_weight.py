...
class PerGroupFp4Weight(CompositeWeight, QuantWeight):
    ...
    def _get_moe_w2_quant_weight(self, src_weight_info: MoeAtomicWeight):
        ...
        kernel = create_w4a4_fp4_per_group_weight(
            src_weight_info,
            W.moe_w2,
            [CkptWeightInfo(replace_weight_suffix(source_name, QW_SUFFIX), identity)],
            stack_,
            data_type=torch.uint8,
            config=src_weight_info.config,
        ...
        scale = create_w4a4_fp4_per_group_weight(
            src_weight_info,
            W.moe_s2,
            [CkptWeightInfo(replace_weight_suffix(source_name, QS_SUFFIX), identity)],
            stack_,
            data_type=torch.float8_e4m3fn,
            config=src_weight_info.config,
            stacked_ckpt_keys=src_weight_info.stacked_ckpt_keys,
        ...
        scale_2 = create_w4a4_fp4_per_group_weight(
            src_weight_info,
            W.moe_w2_s2,
            [CkptWeightInfo(replace_weight_suffix(source_name, QS_2_SUFFIX), identity)],
            stack_,
            data_type=torch.float32,
            config=src_weight_info.config,
            stacked_ckpt_keys=src_weight_info.stacked_ckpt_keys,
        ...
        input_scale = create_w4a4_fp4_per_group_weight(
            ...
            [
                CkptWeightInfo(
                    replace_weight_suffix(source_name, ACT_S_SUFFIX), identity
                )
            ],
            stack_,
            data_type=torch.float32,
    ...
    def _get_moe_w1_quant_weight(self, src_weight_info: MoeAtomicWeight):
        ...
        fused = src_weight_info.stacked_ckpt_keys and len(src_weight_info.weights) == 1
        w1_process = stack_moe_w1_fused if fused else stack_moe_w1
        scalar_process = stack_moe_w1_s2_fused_max if fused else stack_moe_w1_s2
        pair_process = stack_moe_w1_s2_fused if fused else stack_moe_w1_s2_pair
        kernel = create_w4a4_fp4_per_group_weight(
            src_weight_info,
            W.moe_w1,
            [
                CkptWeightInfo(replace_weight_suffix(w.name, QW_SUFFIX), identity)
        ...
        scale = create_w4a4_fp4_per_group_weight(
            ...
            W.moe_s1,
            [
                CkptWeightInfo(replace_weight_suffix(w.name, QS_SUFFIX), identity)
                for w in src_weight_info.weights
            ],
            w1_process,
            data_type=torch.float8_e4m3fn,
        ...
        scale_2 = create_w4a4_fp4_per_group_weight(
            ...
            W.moe_w1_s2,
            [
                CkptWeightInfo(replace_weight_suffix(w.name, QS_2_SUFFIX), identity)
                for w in src_weight_info.weights
            ],
            scalar_process,
            data_type=torch.float32,
        ...
        input_scale = create_w4a4_fp4_per_group_weight(
            ...
            W.moe_w1_i_s,
            [
                CkptWeightInfo(replace_weight_suffix(w.name, ACT_S_SUFFIX), identity)
                for w in src_weight_info.weights
            ],
            scalar_process,
            data_type=torch.float32,
