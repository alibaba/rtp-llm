...
def git_deps():
    git_repository(
        ...
        patches = ["@rtp_llm//3rdparty/aiter:aiter.patch",
                   "@rtp_llm//3rdparty/aiter:gemm_a8w8.patch"],
        patch_cmds = [
        ...
        build_file = "@rtp_llm//3rdparty/aiter:BUILD",
    )
    ...
    new_git_repository(
        ...
        patches = [
            "@rtp_llm//patches/flash_attention:0001-fix-fix-arch-80-compile.patch",
            "@rtp_llm//patches/flash_attention:0002-fix-remove-torch-aten-dep.patch",
            "@rtp_llm//patches/flash_attention:0003-fix-fix-is-local-judge.patch",
        ],
        build_file = str(Label("@rtp_llm//3rdparty/flash_attention:flash_attention.BUILD")),
    )
