                                            ...
                                            const AttentionFP8Weight<T1, T2>* attention_weights)
{
    ...
    if (attention_weights->query_weight.fuse_gemm_bias) {
        PUSH_RANGE(stream_, "qkv gemm bias");
    ...
    if (isFusedMHA(attention_type)) {
        if (!attention_weights->query_weight.fuse_gemm_bias) {
            PUSH_RANGE(stream_, "invokeFP8TrtAddQKVBias");
        ...
        {
            PUSH_RANGE(stream_, "run_fmha_v2");
        ...
        {
            PUSH_RANGE(stream_, "invokeFP8AddFusedQKVBiasRebuildPadding");
        ...
        {
            PUSH_RANGE(stream_, "Q*K batch gemm");
        ...
        {
            PUSH_RANGE(stream_, "QK*V batch gemm");
        ...
        {
            PUSH_RANGE(stream_, "invokeFP8TransposeAttentionOutRemovePadding");
