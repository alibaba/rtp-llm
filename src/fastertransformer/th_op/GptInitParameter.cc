...
#define DEF_PROPERTY(name)                                      \
    .def_readwrite(#name, &RoleSpecialTokens::name##_)
...
#define DEF_PROPERTY(name)                              \
    .def_readwrite(#name, &SpecialTokens::name##_)
...
#define DEF_PROPERTY(name, member)                      \
    .def_readwrite(#name, &GptInitParameter::member)
