...
public:
    ...
    virtual void forward(th::Tensor&              logits,  // (batch_size, beam_width, hidden_size)
                         ...
                         th::optional<th::Tensor> output_index_logits_opt,
                         th::optional<th::Tensor> token_id_for_index_prob_opt,
                       ...
                       th::optional<th::Tensor> num_beams) = 0;
...
private:
    ...
    static ft::NcclParam tensor_para_;
    static ft::NcclParam pipeline_para_;
...
public:
    ...
    th::Tensor forward(th::Tensor               logits,  // (batch_size, beam_width, vocab_size)
                       ...
                       th::optional<th::Tensor> normed_scores,
                       th::optional<th::Tensor> min_normed_scores,
                       th::optional<th::Tensor> num_beams);
