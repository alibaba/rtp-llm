...
void gemm_test(int m, Dim2 dim2, cudaStream_t stream)
{
    ...
    const auto bestTactic = runner.getChosenConfig(reinterpret_cast<const void*>(in_ptr1),
                                                   reinterpret_cast<const void*>(w_ptr1),
                                                   reinterpret_cast<const void*>(s_ptr1),
                                                   nullptr,
                                                   nullptr,
                                                   reinterpret_cast<void*>(out_ptr1),
                                                   m,
                                                   n,
                                                   k,
                                                   k,
