...
public:
    void SetUp();
    void TearDown();
    void singleApplyLoRATest(int                             b,
                             int                             m,
                             int                             k,
                             int                             r,
                             int                             n,
                             num_t*                          expected_output,
                             int*                            lora_ids,
                             int                             lora_num);

    void ApplyNullInputLengthsLoRATest( int                             b,
                                        int                             m,
                                        int                             k,
                                        int                             r,
                                        int                             n,
    ...
    void ApplyDifferentInputLengthsLoRATest(int                             b,
                                            int                             m,
                                            int                             k,
                                            int                             r,
                                            int                             n,
    ...
    num_t h_w[B * K * N] = {
        0.208130, 0.929799, 0.723109, 0.742336, 0.526296,
        0.243658, 0.584592, 0.033153, 0.138717, 0.242235,
        0.815469, 0.793161, 0.278252, 0.481959, 0.819780,
        0.997067, 0.698441, 0.567546, 0.835243, 0.205599,
        0.593172, 0.112347, 0.153457, 0.241708, 0.726237,
        0.701080, 0.203824, 0.651054, 0.774486, 0.436891,
        0.519091, 0.615852, 0.810188, 0.980097, 0.114688,
        0.316765, 0.696505, 0.914275, 0.935104, 0.941178,
    };
    ...
    num_t h_lora_b[B * R * N] = {
        0.697668, 0.800011, 0.161029, 0.282269, 0.681609,
        0.915194, 0.397100, 0.874156, 0.419408, 0.552907,
        0.952738, 0.036165, 0.185231, 0.373417, 0.305100,
        0.932000, 0.175910, 0.269834, 0.150680, 0.031720,
    };
    num_t h_input[B * M * K]  = {
        0.599507, 0.065209, 0.545996, 0.187197,
        0.034023, 0.944246, 0.880180, 0.001236,
        0.593586, 0.415770, 0.417719, 0.271122,
        0.692278, 0.203848, 0.683296, 0.752854,
        0.857936, 0.686956, 0.005132, 0.175652,
        0.749658, 0.604651, 0.109958, 0.212090,
    };
    num_t h_null_input[B * 1 * K]  = {
        0.599507, 0.065209, 0.545996, 0.187197,
        0.034023, 0.944246, 0.880180, 0.001236
    };
    num_t h_output[M * M * N] = {
        0.772555, 1.159351, 0.693839, 0.873585, 0.817399,
        0.956146, 1.282621, 0.301520, 0.581482, 0.968444,
        0.835812, 1.315653, 0.713117, 0.926091, 0.811296,
        1.146724, 1.064500, 1.480865, 1.698900, 1.378753,
        1.048819, 0.361908, 0.743653, 0.908690, 1.089097,
        0.992845, 0.422904, 0.791696, 0.955588, 1.020821,
    };
...
void GemmRunnerTest::singleApplyLoRATest(int                             b,
                                         int                             m,
                                         int                             k,
                                         int                             r,
                                         int                             n,
...
TEST_F(GemmRunnerTest, ApplyLoRASimpleTest)
{
    ...
    num_t expected_output[b * m * n] = {
        2.065056, 2.000078, 1.643932, 1.444821, 1.744666,
        1.865219, 1.861871, 0.982029, 0.984167, 1.614318,
        2.181695, 2.194349, 1.699152, 1.520675, 1.778559,
    };
    int lora_ids[b] = {0};
...
TEST_F(GemmRunnerTest, ApplyLoRASimpleBatchTest)
{
    ...
    num_t expected_output[b * m * n] = {
        ...
        1.865219, 1.861871, 0.982029, 0.984167, 1.614318,
        2.181695, 2.194349, 1.699152, 1.520675, 1.778559,
        2.695979, 1.267407, 1.872953, 2.086061, 1.601371,
        2.547362, 0.546729, 1.115691, 1.300654, 1.326147,
        2.368942, 0.593953, 1.134172, 1.313494, 1.235979,
    };
    int lora_ids[b] = {0, 1};
    singleApplyLoRATest(b, m, k, r, n, expected_output, lora_ids, b);
}
...
TEST_F(GemmRunnerTest, ApplyLoRASameLoRABatchTest)
{
    ...
    constexpr int n = 5;
    num_t expected_output[b * m * n] = {
        1.672604, 1.277066, 0.921522, 1.098759, 0.947041,
        1.816548, 1.392588, 0.517557, 0.800652, 1.097241,
        2.018720, 1.466441, 1.009881, 1.228019, 0.989125,
        2.695979, 1.267407, 1.872953, 2.086061, 1.601371,
        2.547362, 0.546729, 1.115691, 1.300654, 1.326147,
        2.368942, 0.593953, 1.134172, 1.313494, 1.235979,
    };
...
void GemmRunnerTest::ApplyNullInputLengthsLoRATest( int                             b,
                                                    int                             m,
                                                    int                             k,
                                                    int                             r,
                                                    int                             n,
...
void GemmRunnerTest::ApplyDifferentInputLengthsLoRATest(int                             b,
                                                        int                             m,
                                                        int                             k,
                                                        int                             r,
                                                        int                             n,
