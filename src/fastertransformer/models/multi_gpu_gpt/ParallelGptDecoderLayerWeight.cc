...
void ParallelGptDecoderLayerWeight<T>::copyFrom(const ParallelGptDecoderLayerWeight& other)
{
    ...
    cudaD2Dcpy(weights_ptr[3], other.weights_ptr[3], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
    ...
    if (int8_mode_ == 0) {
        cudaD2Dcpy(weights_ptr[2], other.weights_ptr[2], hidden_units_ * (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
        ...
        cudaD2Dcpy(
            int8_weights_ptr[0], other.int8_weights_ptr[0], hidden_units_ * (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
        ...
        if (int8_mode_ == 1) {
            cudaD2Dcpy(weight_only_scale_ptr[0], other.weight_only_scale_ptr[0], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
            ...
            cudaD2Dcpy(scale_inter_ptr[0], other.scale_inter_ptr[0], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
...
ParallelGptDecoderLayerWeight<T>::ParallelGptDecoderLayerWeight(const ParallelGptDecoderLayerWeight& other):
    ...
    head_num_kv_(other.head_num_kv_),
...
void ParallelGptDecoderLayerWeight<T>::mallocWeights()
{
    ...
    deviceMalloc(&weights_ptr[3], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);  // qkv biases
    ...
    if (int8_mode_ == 0) {
        deviceMalloc(&weights_ptr[2], hidden_units_ * (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);  // qkv weight
        ...
        deviceMalloc(&int8_weights_ptr[0], hidden_units_ * (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
        ...
        if (int8_mode_ == 1) {
            ...
            deviceMalloc(&weight_only_scale_ptr[0], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
            ...
            deviceMalloc(&scale_inter_ptr[0], (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_);
...
void ParallelGptDecoderLayerWeight<T>::transposeWeight()
{
    ...
    const std::vector<std::vector<size_t>> shape_list{{hidden_units_, (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tp},
                                                      {hidden_units_ / tp, hidden_units_},
                                                      {hidden_units_, inter_size_ / tp},
                                                      {inter_size_ / tp, hidden_units_}};

    const auto max_size =
        sizeof(int8_t) * std::max((hidden_units_ + 2 * size_per_head_ * head_num_kv_) * hidden_units_ / tp, hidden_units_ * inter_size_ / tp);
...
void ParallelGptDecoderLayerWeight<T>::transposeCalibrateQuantizeWeight()
{
    invokeLdnCalibrateWeightPerChannel(
        scale_ptr[0], weights_ptr[2], hidden_units_, (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_, stream_);
    invokeLdnTransposeQuantizeWeightPerChannel(int8_weights_ptr[0],
                                               scale_ptr[0],
                                               weights_ptr[2],
                                               hidden_units_,
                                               (hidden_units_ + 2 * size_per_head_ * head_num_kv_) / tensor_para_size_,
                                               stream_);
