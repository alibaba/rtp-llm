...
template <typename T>
void serialize_multihead_attention_params(Masked_multihead_attention_params<T> &params,
...
template <typename T>
void deserialize_multihead_attention_params(Masked_multihead_attention_params<T> &params,
                                            const std::string &path)
{
