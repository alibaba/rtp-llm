                              ...
                              bool  isAppend)
{
    ...
    const size_t hidden_units_kv        = head_num_kv * size_per_head;
    const size_t local_head_num_kv      = head_num_kv / tensor_para_size;
    const size_t local_hidden_units_kv  = local_head_num_kv * size_per_head;
    const size_t local_hidden_units_qkv = local_hidden_units + local_hidden_units_kv * 2;
                                   ...
                                   CublasDataType data_type)
{
    ...
    buff_size.push_back(m * hidden_units + hidden_units * local_hidden_units_qkv + m * local_hidden_units_qkv);
