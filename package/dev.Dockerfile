...
# Bootstrap the Bazel 7.7.1 binary mirrored by .bazeliskrc. The build arg
# remains overridable for restricted environments.
ARG BAZELISK_URL=https://rtp-opensource.oss-cn-hangzhou.aliyuncs.com/bazel/7.7.1/bazel-7.7.1-linux-amd64
