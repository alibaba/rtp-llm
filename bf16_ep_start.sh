...
export TOKENIZER_PATH=/root/models/qwen3_5_397B
export CHECKPOINT_PATH=/root/models/qwen3_5_397B
...
/opt/conda310/bin/python3.10 -m rtp_llm.start_server 2>&1 | tee server_bf16_ep.log
