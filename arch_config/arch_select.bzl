...
# These CUDA 12 wheels are not usable on CUDA 13. FlashInfer JIT covers the
# attention kernels; the remaining extensions need CUDA 13 rebuilds.
_CUDA13_DEFERRED = [
    "deep_ep",
...
def whl_deps():
    return select({
        "@rtp_llm//:using_cuda13_x86": [
            ...
            # DeepGEMM ee6161b: nv_dev 2642b32 plus wheel CI, with native SM120 kernels.
            "deep_gemm@https://rtp-maga.oss-cn-zhangjiakou.aliyuncs.com/rtp_llm/deep_gemm/cuda13_sm120/ee6161be60445ec248cf63fced4215ba78ff9b39/deep_gemm-2.6.1%2Bee6161b.cu132-cp310-cp310-linux_x86_64.whl#sha256=4adee1e3b30e3d8db17374935c439781c5f6bb683be7fdc535e34ebe9bb0e081",
            ...
            "flashinfer-python@https://rtp-opensource.oss-cn-hangzhou.aliyuncs.com/rtp_llm/cu129/flashinfer_260523/flashinfer_python-0.6.12rc1%2Brtp.260523-py3-none-any.whl#sha256=deb1c7b7cb42792f10dfb704d5a73b06d12a78db8710e0baf05573699e7d8835",
            "flashinfer-cubin@https://rtp-opensource.oss-cn-hangzhou.aliyuncs.com/rtp_llm/cu129/flashinfer_260523/flashinfer_cubin-0.6.12rc1%2Brtp.260523-py3-none-any.whl#sha256=128abfe7b88706db3ff2c08f2eb83b1d5baf3516fd69ac685b3891390d359be8",
