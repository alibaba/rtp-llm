...
def whl_deps():
    return select({
        "@rtp_llm//:using_cuda13_x86": [
            ...
            "deep_gemm@http://artlab.alibaba-inc.com/1/pypi/rtp_llm/deep_gemm/deep_gemm-2.8.0+4fb5ddc.cu132-cp310-cp310-linux_x86_64.whl",
            ...
            "tilelang==0.1.9",
            "quack-kernels==0.5.3",
            "flash-attn-4@http://artlab.alibaba-inc.com/1/pypi/rtp_llm/flash-attn-4/flash_attn_4-0.0.1.dev1%2Bg466a1da7d-py3-none-any.whl",
