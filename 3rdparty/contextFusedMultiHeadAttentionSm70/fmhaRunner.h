...
{
public:
    MHARunnerSm70(const Data_type dataType, const int numHeads, const int headSize, const float qScaling);

    MHARunnerSm70() = default;

    virtual ~MHARunnerSm70() = default;
...
class FusedMHARunnerV2Sm70 : public MHARunnerSm70
{
public:
    FusedMHARunnerV2Sm70(const Data_type dataType, const int numHeads, const int headSize, const float qScaling);

    ~FusedMHARunnerV2Sm70(); // for pimpl
