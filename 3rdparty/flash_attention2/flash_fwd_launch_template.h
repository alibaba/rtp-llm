...
template<typename Kernel_traits, bool Is_causal, bool Is_alibi, bool Is_even_MN, bool Is_even_K, bool Split, bool Append_KV>
__global__ void flash_fwd_splitkv_kernel(Flash_fwd_params params) {
    flash::compute_attn_splitkv<Kernel_traits, Is_causal, Is_alibi, Is_even_MN, Is_even_K, Split, Append_KV>(params);
}
                ...
                BOOL_SWITCH(params.num_splits > 1, Split, [&] {
                    BOOL_SWITCH(params.knew_ptr != nullptr, Append_KV, [&] {
                        BOOL_SWITCH(params.is_alibi, Is_alibi, [&] {
                            ...
                            auto kernel = &flash_fwd_splitkv_kernel<Kernel_traits, Is_causal, Is_alibi, IsEvenMNConst && !Append_KV, IsEvenKConst, Split, Append_KV>;
...
//     FA_CUDA_CHECK(cudaDeviceGetAttribute(
