...
enum FieldOptions_CType : int {
  ...
  FieldOptions_CType_RAW_STRING = 3
};
...
constexpr FieldOptions_CType FieldOptions_CType_CType_MAX = FieldOptions_CType_RAW_STRING;
...
class PROTOBUF_EXPORT FieldOptions :
 ...
 public:
  ...
  static constexpr CType RAW_STRING =
    FieldOptions_CType_RAW_STRING;
