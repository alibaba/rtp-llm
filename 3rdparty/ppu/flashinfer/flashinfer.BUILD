...
genrule(
    ...
    cmd = "loc=$(locations :aot_build_utils_generate); loc=$${loc%/*};loc=$${loc%/*}; PYTHONPATH=$$loc /opt/conda310/bin/python -m aot_build_utils.generate --enable_fp8_e4m3 true --enable_fp8_e5m2 true --enable_f16 true --use_fp16_qk_reductions false --enable_bf16 true --mask_modes 1 --path $(RULEDIR) --head_dims 64 128 --pos_encoding_modes 0 ",
