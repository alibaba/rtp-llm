...
public:
    ...
    virtual void run(void const* qPtr, rtp_llm::KVBlockArray const& pagedKVCache,
...
public:
    ...
    void run(void const* qPtr, rtp_llm::KVBlockArray const& pagedKVCache,
        void const* cuQSeqlenPtr, void const* cuKVSeqlenPtr, uint32_t* tileCounterPtr, float const* scaleBmm2Ptr,
    ...
    void run(void const* inputPtr, void const* cuQSeqlenPtr, uint32_t* tileCounterPtr, float const* scaleBmm2Ptr,
        void* outputPtr, cudaStream_t stream)
    {
        run(inputPtr, rtp_llm::KVBlockArray(), cuQSeqlenPtr, cuQSeqlenPtr, tileCounterPtr, scaleBmm2Ptr, outputPtr,
            stream);
    }
