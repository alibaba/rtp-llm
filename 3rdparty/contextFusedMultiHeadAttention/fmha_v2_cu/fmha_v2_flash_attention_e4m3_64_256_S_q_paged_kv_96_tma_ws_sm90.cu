...
void fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_tma_ws_sm90_kernel(
...
void fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_causal_tma_ws_sm90_kernel(
    const __grid_constant__ bert::Fused_multihead_attention_params_v2 params){
...
void fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_sliding_or_chunked_causal_tma_ws_sm90_kernel(
    const __grid_constant__ bert::Fused_multihead_attention_params_v2 params){
...
void fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_custom_mask_tma_ws_sm90_kernel(
    const __grid_constant__ bert::Fused_multihead_attention_params_v2 params){
...
void run_fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_tma_ws_sm90(
...
#if 0 // padding_mask
        FMHA_CHECK_CUDA(cudaFuncSetAttribute(fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_tma_ws_sm90_kernel,
                                         cudaFuncAttributeMaxDynamicSharedMemorySize,
                                         SMEM_BYTES));

        fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_tma_ws_sm90_kernel
...
#if 1 // causal_mask
        FMHA_CHECK_CUDA(cudaFuncSetAttribute(fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_causal_tma_ws_sm90_kernel,
                                         cudaFuncAttributeMaxDynamicSharedMemorySize,
                                         SMEM_BYTES));

        fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_causal_tma_ws_sm90_kernel
            <<<block_size, Ktraits::THREADS, SMEM_BYTES, stream>>>(convertKernelParmas2BertParams(params));
#endif // causal mask
    } else if( launch_params.attention_mask_type == Attention_mask_type::SLIDING_OR_CHUNKED_CAUSAL ) {
#if 1 // sliding_or_chunked_causal_mask
        FMHA_CHECK_CUDA(cudaFuncSetAttribute(fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_sliding_or_chunked_causal_tma_ws_sm90_kernel,
                                         cudaFuncAttributeMaxDynamicSharedMemorySize,
                                         SMEM_BYTES));
...
#if 1 // custom_mask
        FMHA_CHECK_CUDA(cudaFuncSetAttribute(fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_custom_mask_tma_ws_sm90_kernel,
                                         cudaFuncAttributeMaxDynamicSharedMemorySize,
                                         SMEM_BYTES));

        fmha_v2_flash_attention_e4m3_64_256_S_q_paged_kv_96_custom_mask_tma_ws_sm90_kernel
            <<<block_size, Ktraits::THREADS, SMEM_BYTES, stream>>>(convertKernelParmas2BertParams(params));
#endif // custom mask
    }
