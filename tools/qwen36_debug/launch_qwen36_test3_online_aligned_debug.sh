...
write_env() {
  local env_file="${RUN_DIR}/launch_env.main.txt"
  {
    ...
    for optional_env in \
      ...
      RTPLLM_DECODE_BAD_WATCH_HISTORY_SIZE \
      ...
      RTPLLM_SAMPLER_TRACE_MAX_OUTPUT_LEN \
      RTPLLM_POST_LAYER_TRACE \
      RTPLLM_POST_LAYER_TRACE_DIR \
      RTPLLM_POST_LAYER_TRACE_FILE \
      RTPLLM_POST_LAYER_TRACE_FILTER \
      RTPLLM_POST_LAYER_TRACE_TOPK \
      RTPLLM_POST_LAYER_TRACE_MAX_OUTPUT_LEN \
      RTPLLM_POST_LAYER_TRACE_MAX_ROWS \
      ...
      RTPLLM_QWEN3_NEXT_TRACE_PREFILL \
